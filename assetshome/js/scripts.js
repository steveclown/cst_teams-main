...
function _pickers() {
  /** Date Picker
			<input type="text" autocomplete="off"  class="form-control datepicker" data-format="yyyy-mm-dd" data-lang="en" data-RTL="false">
		 ******************* **/
  ...
  /** Range Picker
			<input type="text" autocomplete="off"  class="form-control rangepicker" value="2015-01-01 - 2016-12-31" data-format="yyyy-mm-dd" data-from="2015-01-01" data-to="2016-12-31">
		 ******************* **/
  ...
  /** Time Picker
			<input type="text" autocomplete="off"  class="form-control timepicker" value="11 : 55 : PM">
		 ******************* **/
        ...
        if (jQuery().slimScroll) {
          jQuery(".slimscroll").each(function () {
            ...
            jQuery(this).slimScroll({
              ...
              alwaysVisible:
                jQuery(this).attr("data-alwaysVisible") != "false"
                  ? true
                  : false,
              railVisible:
