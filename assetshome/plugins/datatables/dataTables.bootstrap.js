    ...
    fnInit: function (oSettings, nPaging, fnDraw) {
      ...
      $(nPaging).append(
        '<div class="pagination-panel"> ' +
          ...
          '<input type="text" autocomplete="off"  class="pagination-panel-input form-control input-mini input-inline input-sm" maxlenght="5" style="text-align:center; margin: 0 5px;">' +
      ...
      $(".pagination-panel-input", nPaging).bind("keypress.DT", function (e) {
        ...
        if (e.which == 13) {
          ...
          if (
            page > 0 &&
            page <= oSettings.oInstance.fnPagingInfo().iTotalPages
          ) {
            if (oSettings.oApi._fnPageChange(oSettings, page - 1)) {
              fnDraw(oSettings);
            }
