  ...
  (s.prototype = {
    ...
    _init: function () {
      ...
      (this.$element.parent().hasClass("input-append") ||
        ...
        (this.$widget =
          this.template !== !1
            ? t(this.getTemplate()).on("click", t.proxy(this.widgetClick, this))
            : !1),
        this.showInputs &&
          this.$widget !== !1 &&
    ...
    decrementMinute: function (t) {
      ...
      (i = t ? this.minute - t : this.minute - this.minuteStep),
        0 > i
          ? (this.decrementHour(), (this.minute = i + 60))
          : (this.minute = i);
    },
    ...
    getTemplate: function () {
      ...
      switch (
        (this.showInputs
          ...
          : ((i = '<span class="bootstrap-timepicker-hour"></span>'),
            (e = '<span class="bootstrap-timepicker-minute"></span>'),
            (s = '<span class="bootstrap-timepicker-second"></span>'),
            (n = '<span class="bootstrap-timepicker-meridian"></span>')),
        (h =
          '<table><tr><td><a href="#" data-action="incrementHour"><i class="fa fa-angle-up"></i></a></td><td class="separator">&nbsp;</td><td><a href="#" data-action="incrementMinute"><i class="fa fa-angle-up"></i></a></td>' +
          (this.showSeconds
            ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="incrementSecond"><i class="fa fa-angle-up"></i></a></td>'
            : "") +
          (this.showMeridian
            ? '<td class="separator">&nbsp;</td><td class="meridian-column"><a href="#" data-action="toggleMeridian"><i class="fa fa-angle-up"></i></a></td>'
            : "") +
          "</tr><tr><td>" +
          i +
          ...
          (this.showMeridian
            ...
            : "") +
          '</tr><tr><td><a href="#" data-action="decrementHour"><i class="fa fa-angle-down"></i></a></td><td class="separator"></td><td><a href="#" data-action="decrementMinute"><i class="fa fa-angle-down"></i></a></td>' +
          (this.showSeconds
            ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="decrementSecond"><i class="fa fa-angle-down"></i></a></td>'
            : "") +
          (this.showMeridian
            ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="toggleMeridian"><i class="fa fa-angle-down"></i></a></td>'
            : "") +
          "</tr></table>"),
        this.template)
      ) {
    ...
    hideWidget: function () {
      this.isOpen !== !1 &&
        ...
        t(e).off("mousedown.timepicker, touchend.timepicker"),
        (this.isOpen = !1),
        this.$widget.detach());
    },
    ...
    incrementMinute: function (t) {
      ...
      (i = t
        ...
        i > 59
          ? (this.incrementHour(), (this.minute = i - 60))
          : (this.minute = i);
    },
    ...
    mousewheel: function (i) {
      if (!this.disableMousewheel) {
        ...
        switch (
          ("mousewheel" === i.type
            ? (s = -1 * i.originalEvent.wheelDelta)
            : "DOMMouseScroll" === i.type && (s = 40 * i.originalEvent.detail),
          s && (i.preventDefault(), t(this).scrollTop(s + t(this).scrollTop())),
          this.highlightedUnit)
        ) {
          case "minute":
            e > 0 ? this.incrementMinute() : this.decrementMinute(),
              this.highlightMinute();
            break;
          case "second":
            e > 0 ? this.incrementSecond() : this.decrementSecond(),
              this.highlightSecond();
            break;
          case "meridian":
            this.toggleMeridian(), this.highlightMeridian();
            break;
          default:
            e > 0 ? this.incrementHour() : this.decrementHour(),
              this.highlightHour();
        }
        return !1;
      }
    ...
    place: function () {
      if (!this.isInline) {
        ...
        this.$widget.removeClass(
          ...
          "auto" !== this.orientation.x
            ? (this.picker.addClass("datepicker-orient-" + this.orientation.x),
              "right" === this.orientation.x && (u -= e - l))
        ...
        var m,
          g,
          f = this.orientation.y;
        "auto" === f &&
          ((m = -a + d.top - s),
          (g = a + o - (d.top + c + s)),
          (f = Math.max(m, g) === g ? "top" : "bottom")),
          this.$widget.addClass("timepicker-orient-" + f),
          "top" === f
            ? (p += c)
            : (p -= s + parseInt(this.$widget.css("padding-top"), 10)),
          this.$widget.css({ top: p, left: u, zIndex: r });
      }
    },
    remove: function () {
    ...
    setDefaultTime: function (t) {
      if (this.$element.val()) this.updateFromElementVal();
        ...
        var i = new Date(),
          ...
          h = "AM";
        0 !== n &&
          ((n = Math.ceil(i.getSeconds() / this.secondStep) * this.secondStep),
          60 === n && ((s += 1), (n = 0))),
          0 !== s &&
            ((s =
              Math.ceil(i.getMinutes() / this.minuteStep) * this.minuteStep),
            60 === s && ((e += 1), (s = 0))),
          this.showMeridian &&
            (0 === e
              ? (e = 12)
    ...
    setTime: function (t, i) {
      ...
      "object" == typeof t && t.getMonth
        ...
        : ((o = null !== t.match(/p/i) ? "PM" : "AM"),
          (t = t.replace(/[^0-9\:]/g, "")),
          (e = t.split(":")),
          (s = e[0] ? e[0].toString() : e.toString()),
          (n = e[1] ? e[1].toString() : ""),
          (h = e[2] ? e[2].toString() : ""),
          s.length > 4 && (h = s.substr(4, 2)),
          s.length > 2 && ((n = s.substr(2, 2)), (s = s.substr(0, 2))),
          n.length > 2 && ((h = n.substr(2, 2)), (n = n.substr(0, 2))),
          h.length > 2 && (h = h.substr(2, 2)),
          (s = parseInt(s, 10)),
          (n = parseInt(n, 10)),
          (h = parseInt(h, 10)),
          isNaN(s) && (s = 0),
    ...
    showWidget: function () {
      if (!this.isOpen && !this.$element.is(":disabled")) {
        ...
        t(e).on("mousedown.timepicker, touchend.timepicker", function (t) {
          i.$element.parent().find(t.target).length ||
            i.$widget.is(t.target) ||
            i.$widget.find(t.target).length ||
            i.hideWidget();
        }),
          this.$element.trigger({
      ...
      if (this.$widget !== !1) {
        ...
        this.showInputs
          ? (this.$widget.find("input.bootstrap-timepicker-hour").val(t),
            this.$widget.find("input.bootstrap-timepicker-minute").val(i),
            this.showSeconds &&
              this.$widget.find("input.bootstrap-timepicker-second").val(e),
            this.showMeridian &&
              this.$widget
                .find("input.bootstrap-timepicker-meridian")
                .val(this.meridian))
          : (this.$widget.find("span.bootstrap-timepicker-hour").text(t),
            this.$widget.find("span.bootstrap-timepicker-minute").text(i),
            this.showSeconds &&
              this.$widget.find("span.bootstrap-timepicker-second").text(e),
            this.showMeridian &&
              this.$widget
    ...
    widgetClick: function (i) {
      ...
      s && this[s](),
        this.update(),
        e.is("input") && e.get(0).setSelectionRange(0, 2);
    },
        ...
        this.each(function () {
          ...
          h ||
            n.data(
              ...
              (h = new s(
                this,
                t.extend({}, t.fn.timepicker.defaults, o, t(this).data())
              ))
            ),
            "string" == typeof i && h[i].apply(h, e);
        })
      );
    }),
