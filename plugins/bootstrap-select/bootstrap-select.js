  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      var searchbox = this.options.liveSearch
        ? '<div class="bootstrap-select-searchbox"><input type="text" autocomplete="off"  class="input-block-level form-control" /></div>'
        : "";
      var drop =
    ...
    setSize: function () {
      ...
      if (this.options.size == "auto") {
        var getSize = function () {
          ...
          menuInner.css({
            "max-height":
              menuHeight - headerHeight - searchHeight - menuPadding + "px",
            "overflow-y": "auto",
