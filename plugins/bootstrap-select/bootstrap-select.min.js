  ...
  a.prototype = {
    ...
    liHeight: function () {
      var e = this.$menu
        ...
        g = this.options.liveSearch
          ? f.find(".bootstrap-select-searchbox").outerHeight()
          : 0;
      e.remove();
      this.$newElement
        .data("liHeight", d)
    ...
    setSize: function () {
      ...
      if (this.options.size == "auto") {
        ...
        if (
          ...
          d.find("li" + o).length > this.options.size
        ) {
          var m = d
            .find("li" + o + " > *")
          ...
          d.css({ "max-height": p + r + l + "px", overflow: "hidden" });
          i.css({ "max-height": p - q + "px", "overflow-y": "auto" });
        }
      }
    },
    setWidth: function () {
    ...
    selectPosition: function () {
      var e = this,
        ...
        g,
        c = function (i) {
          f.addClass(i.attr("class")).toggleClass(
            "dropup",
            i.hasClass("dropup")
          );
          h = i.offset();
    ...
    clickListener: function () {
      ...
      this.$menu.on("click", "li a", function (k) {
        ...
        if (!c.isDisabled() && !b(this).parent().hasClass("disabled")) {
          ...
          if (
            (j != c.$element.val() && c.multiple) ||
            (f != c.$element.prop("selectedIndex") && !c.multiple)
          ) {
            c.$element.change();
          }
        }
