...
!(function (t) {
  "use strict";
  var e = function (e, i) {
    (this.options = t.extend({}, t.fn.editableform.defaults, i)),
      (this.$div = t(e)),
  ...
  (e.prototype = {
    ...
    initButtons: function () {
      ...
      e.append(t.fn.editableform.buttons),
        "bottom" === this.options.showbuttons &&
          e.addClass("editable-buttons-bottom");
    },
    render: function () {
    ...
    showLoading: function () {
      var t, e;
      this.$form
        ? ((t = this.$form.outerWidth()),
          (e = this.$form.outerHeight()),
          t && this.$loading.width(t),
          e && this.$loading.height(e),
          this.$form.hide())
        : ((t = this.$loading.parent().width()), t && this.$loading.width(t)),
        this.$loading.show();
    },
    showForm: function (t) {
      this.$loading.hide(),
    ...
    error: function (e) {
      var i,
        ...
        o = this.$form.find(".editable-error-block");
      if (e === !1)
        n.removeClass(t.fn.editableform.errorGroupClass),
          o.removeClass(t.fn.editableform.errorBlockClass).empty().hide();
      else {
        if (e) {
          i = e.split("\n");
        ...
        n.addClass(t.fn.editableform.errorGroupClass),
          o.addClass(t.fn.editableform.errorBlockClass).html(e).show();
      }
    },
    submit: function (e) {
      e.stopPropagation(), e.preventDefault();
      var i,
        n = this.input.input2value();
      if ((i = this.validate(n))) return this.error(i), this.showForm(), void 0;
      if (
        !this.options.savenochange &&
        this.input.value2str(n) == this.input.value2str(this.value)
      )
            ...
            t.proxy(function (t) {
              ...
              var e =
                "function" == typeof this.options.success
                  ? this.options.success.call(this.options.scope, t, n)
                  : null;
              return e === !1
                ? (this.error(!1), this.showForm(!1), void 0)
                : "string" == typeof e
                ? (this.error(e), this.showForm(), void 0)
                : (e &&
                    "object" == typeof e &&
            ...
            t.proxy(function (t) {
              ...
              (e =
                "function" == typeof this.options.error
                  ? this.options.error.call(this.options.scope, t, n)
                  : "string" == typeof t
                  ? t
                  : t.responseText || t.statusText || "Unknown error!"),
                this.error(e),
                this.showForm();
            }, this)
          );
        ...
        o = !!(
          ...
          (this.options.url &&
            ("always" === this.options.send ||
              ("auto" === this.options.send && null !== n && void 0 !== n)))
        );
      return o
        ? (this.showLoading(),
          (i = { name: this.options.name || "", value: e, pk: n }),
          "function" == typeof this.options.params
            ? (i = this.options.params.call(this.options.scope, i))
            : ((this.options.params = t.fn.editableutils.tryParseJson(
                this.options.params,
                !0
              )),
              t.extend(i, this.options.params)),
          "function" == typeof this.options.url
            ? this.options.url.call(this.options.scope, i)
            : t.ajax(
                t.extend(
                  { url: this.options.url, data: i, type: "POST" },
    ...
    validate: function (t) {
      return (
        ...
        "function" == typeof this.options.validate
          ? this.options.validate.call(this.options.scope, t)
          : void 0
      );
    },
    option: function (t, e) {
    ...
    (t.fn.editableform = function (i) {
      ...
      return this.each(function () {
        var o = t(this),
          ...
          s = "object" == typeof i && i;
        r || o.data("editableform", (r = new e(this, s))),
          "string" == typeof i &&
            r[i].apply(r, Array.prototype.slice.call(n, 1));
      });
    }),
    ...
    (t.fn.editableform.template =
      '<form class="form-inline editableform"><div class="form-group"><div><div class="editable-input"></div><div class="editable-buttons"></div></div><div class="editable-error-block"></div></div></form>'),
    (t.fn.editableform.loading = '<div class="editableform-loading"></div>'),
    (t.fn.editableform.buttons =
    ...
    t.fn.editableutils = {
      ...
      sliceObj: function (e, i, n) {
        ...
        for (var a = 0; a < i.length; a++)
          (o = i[a]),
            ...
            n !== !0 &&
              ((r = o.toLowerCase()), e.hasOwnProperty(r) && (s[o] = e[r]));
        return s;
      },
      ...
      itemsByValue: function (e, i, n) {
        ...
        return (
          t.each(i, function (i, o) {
            if (o.children) s = s.concat(a.itemsByValue(e, o.children, n));
            else if (r)
              t.grep(e, function (t) {
      ...
      createInput: function (e) {
        ...
        return (
          "date" === r &&
            ("inline" === e.mode
              ? t.fn.editabletypes.datefield
                ? (r = "datefield")
                : t.fn.editabletypes.dateuifield && (r = "dateuifield")
              : t.fn.editabletypes.date
              ? (r = "date")
              : t.fn.editabletypes.dateui && (r = "dateui"),
            "date" !== r || t.fn.editabletypes.date || (r = "combodate")),
          "datetime" === r && "inline" === e.mode && (r = "datetimefield"),
          "wysihtml5" !== r || t.fn.editabletypes[r] || (r = "textarea"),
          "function" == typeof t.fn.editabletypes[r]
            ? ((i = t.fn.editabletypes[r]),
              (n = this.sliceObj(e, this.objectKeys(i.defaults))),
              (o = new i(n)))
            : (t.error("Unknown type: " + r), !1)
        );
      },
  ...
  (function (t) {
    ...
    (e.prototype = {
      ...
      init: function (i, n) {
        (this.$element = t(i)),
          (this.options = t.extend({}, t.fn.editableContainer.defaults, n)),
          this.splitOptions(),
          ...
          t(document).data("editable-handlers-attached") ||
            (t(document).on("keyup.editable", function (e) {
            ...
            t(document).on("click.editable", function (i) {
              ...
              if (
                t.contains(document.documentElement, i.target) &&
                !o.is(document)
              ) {
      ...
      splitOptions: function () {
        if (
          ...
          (this.formOptions = {}),
          !t.fn[this.containerName])
        )
          throw new Error(
            this.containerName +
              " not found. Have you included corresponding js file?"
          );
        var e = t.fn[this.containerName].defaults;
        for (var i in this.options)
          i in e
            ? (this.containerOptions[i] = this.options[i])
            : (this.formOptions[i] = this.options[i]);
      },
      tip: function () {
      ...
      container: function () {
        ...
        return this.containerDataName &&
          (t = this.$element.data(this.containerDataName))
          ? t
          : (t = this.$element.data(this.containerName));
      },
      call: function () {
          ...
          .on({
            ...
            rendered: t.proxy(function () {
              this.$element.triggerHandler(
                "shown",
                t(this.options.scope).data("editable")
              );
            }, this),
          })
          .editableform("render");
      ...
      hide: function (t) {
        if (
          ...
          if (this.$form.data("editableform").isSaving)
            return (this.delayedHide = { reason: t }), void 0;
          (this.delayedHide = !1),
      ...
      option: function (t, e) {
        (this.options[t] = e),
          t in this.containerOptions
            ? ((this.containerOptions[t] = e), this.setContainerOption(t, e))
            : ((this.formOptions[t] = e),
              this.$form && this.$form.editableform("option", t, e));
      },
      ...
      closeOthers: function (e) {
        t(".editable-open").each(function (i, n) {
          if (n !== e && !t(n).find(e).length) {
            var o = t(n),
              r = o.data("editableContainer");
            r &&
              ("cancel" === r.options.onblur
                ? o.data("editableContainer").hide("onblur")
                : "submit" === r.options.onblur &&
                  o.data("editableContainer").tip().find("form").submit());
          }
        });
      },
      activate: function () {
      ...
      (t.fn.editableContainer = function (n) {
        ...
        return this.each(function () {
          var r = t(this),
            ...
            l = "object" == typeof n && n,
            c = "inline" === l.mode ? i : e;
          a || r.data(s, (a = new c(this, l))),
            "string" == typeof n &&
              a[n].apply(a, Array.prototype.slice.call(o, 1));
        });
      }),
      (t.fn.editableContainer.Popup = e),
      (t.fn.editableContainer.Inline = i),
  ...
  (function (t) {
    "use strict";
    t.extend(
      t.fn.editableContainer.Inline.prototype,
      t.fn.editableContainer.Popup.prototype,
      {
    ...
    var e = function (e, i) {
      (this.$element = t(e)),
        (this.options = t.extend(
          ...
          i,
          t.fn.editableutils.getConfigData(this.$element)
        )),
        this.options.selector ? this.initLive() : this.init(),
        this.options.highlight &&
          !t.fn.editableutils.supportsTransitions() &&
    ...
    (e.prototype = {
      ...
      init: function () {
        ...
        if (
          ...
          (this.input = t.fn.editableutils.createInput(this.options)),
          this.input)
        ) {
          switch (
            (void 0 === this.options.value || null === this.options.value
              ? ((this.value = this.input.html2value(
                  t.trim(this.$element.html())
                )),
                (i = !0))
              : ((this.options.value = t.fn.editableutils.tryParseJson(
                  this.options.value,
                  !0
                )),
                (this.value =
            ...
            case "auto":
              e =
                !t.trim(this.$element.text()).length &&
                null !== this.value &&
                void 0 !== this.value &&
                !i;
              break;
        ...
        (this.options.selector = !1),
          ...
          this.$element.on(
            ...
            t.proxy(function (e) {
              var i = t(e.target);
              i.data("editable") ||
                (i.hasClass(this.options.emptyclass) && i.empty(),
                i.editable(this.options).trigger(e));
            }, this)
          );
      },
      render: function (t) {
        return this.options.display !== !1
          ? this.input.value2htmlFinal
            ...
            : "function" == typeof this.options.display
            ? this.options.display.call(this.$element[0], this.value, t)
          ...
          : ((this.options[e] = i),
            "disabled" === e
              ? i
                ? this.disable()
                : this.enable()
              : ("value" === e && this.setValue(i),
                this.container && this.container.option(e, i),
                this.input.option && this.input.option(e, i),
                void 0));
      },
      ...
      show: function (e) {
        if (!this.options.disabled) {
          if (this.container) {
            ...
            this.$element.editableContainer(i),
      ...
      save: function (t, e) {
        if (this.options.unsavedclass) {
          var i = !1;
          (i = i || "function" == typeof this.options.url),
            (i = i || this.options.display === !1),
            (i = i || void 0 !== e.response),
            (i =
              i ||
              (this.options.savenochange &&
                this.input.value2str(this.value) !==
                  this.input.value2str(e.newValue))),
            i
        ...
        if (this.options.highlight) {
          ...
          n.css("background-color", this.options.highlight),
            setTimeout(function () {
              "transparent" === o && (o = ""),
                n.css("background-color", o),
                n.addClass("editable-bg-transition"),
                setTimeout(function () {
      ...
      setValue: function (e, i, n) {
        (this.value = i ? this.input.str2value(e) : e),
          this.container && this.container.option("value", this.value),
          t.when(this.render(n)).then(
            t.proxy(function () {
              this.handleEmpty();
            }, this)
          );
              ...
              2 === arguments.length && arguments[1] === !0
                ...
                : this.each(function () {
                    ...
                    i &&
                      void 0 !== i.value &&
                      null !== i.value &&
                      (n[i.options.name] = i.input.value2submit(i.value));
                  }),
              n
            );
          case "submit":
            var s,
              a = arguments[1] || {},
              l = this,
              c = this.editable("validate");
            return (
              t.isEmptyObject(c)
                ? ((s = this.editable("getValue")),
                  a.data && t.extend(s, a.data),
                  t
                    .ajax(
                      t.extend(
                        { url: a.url, data: s, type: "POST" },
                        a.ajaxOptions
                      )
                    )
                    .success(function (t) {
                    ...
                    .error(function () {
                      "function" == typeof a.error &&
                        a.error.apply(l, arguments);
                    }))
                : "function" == typeof a.error && a.error.call(l, c),
              this
            );
        }
        return this.each(function () {
          var n = t(this),
            ...
            a = "object" == typeof i && i;
          return a && a.selector
            ? ((s = new e(this, a)), void 0)
            : (s || n.data(r, (s = new e(this, a))),
              "string" == typeof i &&
                s[i].apply(s, Array.prototype.slice.call(o, 1)),
              void 0);
        });
      }),
      (t.fn.editable.defaults = {
    ...
    (e.prototype = {
      ...
      setAttr: function (t) {
        void 0 !== this.options[t] &&
          null !== this.options[t] &&
          this.$input.attr(t, this.options[t]);
      },
      option: function (t, e) {
        this.options[t] = e;
      },
      ...
      t.extend(e.prototype, {
        ...
        value2html: function (e, i, n, o) {
          var r = t.Deferred(),
            s = function () {
              "function" == typeof n
                ? n.call(i, e, this.sourceData, o)
                : this.value2htmlFinal(e, i),
                r.resolve();
            };
          return (
            null === e
              ? s.call(this)
              : this.onSourceReady(s, function () {
                  r.resolve();
                }),
            r.promise()
          );
        ...
        onSourceReady: function (e, i) {
          var n;
          if (
            (t.isFunction(this.options.source)
              ? ((n = this.options.source.call(this.options.scope)),
                (this.sourceData = null))
              : (n = this.options.source),
            this.options.sourceCache && t.isArray(this.sourceData))
          )
          ...
          if ("string" == typeof n) {
            if (this.options.sourceCache) {
              var r,
                s = n;
              if (
                (t(document).data(s) || t(document).data(s, {}),
                (r = t(document).data(s)),
                r.loading === !1 && r.sourceData)
              )
                return (
                  (this.sourceData = r.sourceData),
                  this.doPrepend(),
                  e.call(this),
                  void 0
                );
              if (r.loading === !0)
                return (
                  ...
                  r.err_callbacks.push(t.proxy(i, this)),
                  void 0
                );
            ...
            t.ajax({
              ...
              success: t.proxy(function (n) {
                r && (r.loading = !1),
                  (this.sourceData = this.makeArray(n)),
                  t.isArray(this.sourceData)
                    ? (r &&
                        ((r.sourceData = this.sourceData),
                        t.each(r.callbacks, function () {
                          this.call();
                        })),
                      this.doPrepend(),
                      e.call(this))
                    : (i.call(this),
                      r &&
                        t.each(r.err_callbacks, function () {
                          this.call();
                        }));
              }, this),
            ...
            (this.sourceData = this.makeArray(n)),
              t.isArray(this.sourceData)
                ? (this.doPrepend(), e.call(this))
                : i.call(this);
        },
        doPrepend: function () {
          null !== this.options.prepend &&
            void 0 !== this.options.prepend &&
            (t.isArray(this.prependData) ||
              (t.isFunction(this.options.prepend) &&
                (this.options.prepend = this.options.prepend.call(
                  this.options.scope
                )),
              (this.options.prepend = t.fn.editableutils.tryParseJson(
                ...
                "object" == typeof o
                  ? ((i = 0),
                    ...
                    1 === i
                      ...
                      : i > 1 &&
                        (o.children &&
                          (o.children = this.makeArray(o.children)),
                        s.push(o)))
                  : s.push({ value: o, text: o });
          } else
      ...
      t.extend(e.prototype, {
        ...
        activate: function () {
          this.$input.is(":visible") &&
            (this.$input.focus(),
            t.fn.editableutils.setCursorPosition(
              this.$input.get(0),
        ...
        renderClear: function () {
          this.options.clear &&
            ((this.$clear = t('<span class="editable-clear-x"></span>')),
            this.$input
              .after(this.$clear)
            ...
            this.$clear.click(t.proxy(this.clear, this)));
        },
        postrender: function () {},
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.list),
      t.extend(e.prototype, {
            ...
            if (t.isArray(n))
              for (var r = 0; r < n.length; r++)
                (o = {}),
                  n[r].children
                    ? ((o.label = n[r].text),
                      i.append(e(t("<optgroup>", o), n[r].children)))
                    : ((o.value = n[r].value),
                      n[r].disabled && (o.disabled = !0),
                      i.append(t("<option>", o).text(n[r].text)));
            return i;
          };
        ...
        value2htmlFinal: function (e, i) {
          var n = "",
            o = t.fn.editableutils.itemsByValue(e, this.sourceData);
          o.length && (n = o[0].text), t(i).text(n);
        },
        autosubmit: function () {
          this.$input
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.list),
      t.extend(e.prototype, {
          ...
          if ((this.$tpl.empty(), t.isArray(this.sourceData))) {
            for (var i = 0; i < this.sourceData.length; i++)
              (e = t("<label>")
                ...
                .append(t("<span>").text(" " + this.sourceData[i].text))),
        ...
        value2str: function (e) {
          return t.isArray(e)
            ? e.sort().join(t.trim(this.options.separator))
            : "";
        },
        str2value: function (e) {
          ...
          return (
            "string" == typeof e && e.length
              ? ((i = new RegExp(
                  "\\s*" + t.trim(this.options.separator) + "\\s*"
                )),
                (n = e.split(i)))
              : (n = t.isArray(e) ? e : [e]),
            n
        ...
        input2value: function () {
          var e = [];
          return (
            this.$input.filter(":checked").each(function (i, n) {
              e.push(t(n).val());
            }),
            e
          );
  ...
  (function (t) {
    ...
    var e = function (i) {
      if (
        (this.init("select2", i, e.defaults),
        (i.select2 = i.select2 || {}),
        (this.sourceData = null),
        i.placeholder && (i.select2.placeholder = i.placeholder),
        !i.select2.tags && i.source)
      ) {
        var n = i.source;
        t.isFunction(i.source) && (n = i.source.call(i.scope)),
          "string" == typeof n
            ? ((i.select2.ajax = i.select2.ajax || {}),
              i.select2.ajax.data ||
                (i.select2.ajax.data = function (t) {
                  return { query: t };
                }),
              i.select2.ajax.results ||
                (i.select2.ajax.results = function (t) {
                  return { results: t };
                }),
              (i.select2.ajax.url = n))
            : ((this.sourceData = this.convertSource(n)),
              (i.select2.data = this.sourceData));
      }
      if (
        ((this.options.select2 = t.extend({}, e.defaults.select2, i.select2)),
        (this.isMultiple =
      ...
      (this.formatSelection = this.options.select2.formatSelection),
        "function" != typeof this.formatSelection &&
          (this.formatSelection = function (t) {
            return t.text;
          });
    };
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput),
      t.extend(e.prototype, {
        ...
        value2html: function (e, i) {
          ...
          this.options.select2.tags
            ? (n = e)
            : this.sourceData &&
              (n = t.fn.editableutils.itemsByValue(
                e,
                this.sourceData,
                this.idFunc
              )),
            t.isArray(n)
              ...
              : n && (o = r.formatSelection(n)),
            (o = t.isArray(o) ? o.join(this.options.viewseparator) : o),
            t(i).text(o);
        },
        html2value: function (t) {
          return this.options.select2.tags
            ? this.str2value(t, this.options.viewseparator)
            : null;
        },
        value2input: function (e) {
          if (
        ...
        str2value: function (e, i) {
          ...
          i =
            ...
            t.fn.select2.defaults.separator;
          var n, o, r;
          if (null === e || e.length < 1) return null;
          for (n = e.split(i), o = 0, r = n.length; r > o; o += 1)
            n[o] = t.trim(n[o]);
          return n;
        },
        autosubmit: function () {
        ...
        convertSource: function (e) {
          if (t.isArray(e) && e.length && void 0 !== e[0].value)
            for (var i = 0; i < e.length; i++)
              void 0 !== e[i].value &&
                ((e[i].id = e[i].value), delete e[i].value);
          return e;
        },
        destroy: function () {
      ...
      return (
        ...
        this.$element.is("input")
          ? ((this.options = t.extend(
            ...
            this.init(),
            void 0)
          : (t.error("Combodate should be applied to INPUT element"), void 0)
      );
    };
    (e.prototype = {
      constructor: e,
      init: function () {
        (this.map = {
          ...
          (this.$widget = t('<span class="combodate"></span>').html(
            this.getTemplate()
          )),
          this.initCombos(),
          this.$widget.on(
      ...
      getTemplate: function () {
        ...
        return (
          t.each(this.map, function (t, i) {
            i = i[0];
            var n = new RegExp(i + "+"),
              o = i.length > 1 ? i.substring(1, 2) : i;
            e = e.replace(n, "{" + o + "}");
          }),
          (e = e.replace(/ /g, "&nbsp;")),
          t.each(this.map, function (t, i) {
            ...
            e = e.replace(
              "{" + n + "}",
              '<select class="form-control ' + t + '"></select>'
            );
          }),
          e
        );
      ...
      initCombos: function () {
        ...
        t.each(this.map, function (t) {
          ...
          o.length &&
            ((e["$" + t] = o),
            (i = "fill" + t.charAt(0).toUpperCase() + t.slice(1)),
            (n = e[i]()),
            e["$" + t].html(e.renderItems(n)));
        });
      },
      ...
      fillMonth: function () {
        var t,
          ...
          r = -1 !== this.options.template.indexOf("MM");
        for (e = 0; 11 >= e; e++)
          (t = n
            ? moment().date(1).month(e).format("MMMM")
            : o
            ? moment().date(1).month(e).format("MMM")
            : r
            ? this.leadZero(e + 1)
            : e + 1),
            i.push([e, t]);
      ...
      fillYear: function () {
        ...
        for (e = this.options.maxYear; e >= this.options.minYear; e--)
          (t = n ? e : (e + "").substring(2)),
            i[this.options.yearDescending ? "push" : "unshift"]([e, t]);
      ...
      fillHour: function () {
        var t,
          ...
          r = n ? 1 : 0,
          s = n ? 12 : 23;
        for (e = r; s >= e; e++) (t = o ? this.leadZero(e) : e), i.push([e, t]);
        return i;
      },
      fillMinute: function () {
        var t,
        ...
        for (e = 0; 59 >= e; e += this.options.minuteStep)
          (t = n ? this.leadZero(e) : e), i.push([e, t]);
        return i;
      },
      fillSecond: function () {
        ...
        for (e = 0; 59 >= e; e += this.options.secondStep)
          (t = n ? this.leadZero(e) : e), i.push([e, t]);
        return i;
      },
      fillAmpm: function () {
        ...
        return (
          t.each(this.map, function (t) {
            if ("ampm" !== t) {
              var e = "day" === t ? 1 : 0;
              return (
                (n[t] = o["$" + t] ? parseInt(o["$" + t].val(), 10) : e),
                isNaN(n[t]) ? ((r = !0), !1) : void 0
              );
            }
          }),
          r
            ...
            : (this.$ampm &&
              ...
              this.highlight(i),
              (e = void 0 === e ? this.options.format : e),
              null === e
                ? i.isValid()
                  ? i
                  : null
      ...
      setValue: function (e) {
        function i(e, i) {
          var n = {};
          return (
            e.children("option").each(function (e, o) {
              var r,
                s = t(o).attr("value");
              "" !== s &&
                ((r = Math.abs(s - i)),
                ("undefined" == typeof n.distance || r < n.distance) &&
                  (n = { value: s, distance: r }));
            }),
            n.value
          );
        }
        if (e) {
          var n =
              "string" == typeof e ? moment(e, this.options.format) : moment(e),
            o = this,
            r = {};
          n.isValid() &&
            (t.each(this.map, function (t, e) {
              "ampm" !== t && (r[t] = n[e[1]]());
            }),
            this.$ampm &&
              (r.hour >= 12
                ? ((r.ampm = "pm"), r.hour > 12 && (r.hour -= 12))
                : ((r.ampm = "am"), 0 === r.hour && (r.hour = 12))),
            t.each(r, function (t, e) {
              o["$" + t] &&
                ("minute" === t &&
                  o.options.minuteStep > 1 &&
                  o.options.roundTime &&
                  (e = i(o["$" + t], e)),
                "second" === t &&
                  o.options.secondStep > 1 &&
                  o.options.roundTime &&
                  (e = i(o["$" + t], e)),
                o["$" + t].val(e));
            }),
      ...
      (t.fn.combodate = function (i) {
        ...
        return (
          ...
          "getValue" === i && this.length && (n = this.eq(0).data("combodate"))
            ? n.getValue.apply(n, o)
            : this.each(function () {
                var n = t(this),
                  r = n.data("combodate"),
                  s = "object" == typeof i && i;
                r || n.data("combodate", (r = new e(this, s))),
                  "string" == typeof i &&
                    "function" == typeof r[i] &&
                    r[i].apply(r, o);
              })
  ...
  (function (t) {
    "use strict";
    var e = function (i) {
      this.init("combodate", i, e.defaults),
        this.options.viewformat ||
          (this.options.viewformat = this.options.format),
        (i.combodate = t.fn.editableutils.tryParseJson(i.combodate, !0)),
        (this.options.combodate = t.extend(
          {},
          e.defaults.combodate,
          i.combodate,
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput),
      t.extend(e.prototype, {
        ...
        value2html: function (e, i) {
          var n = e ? e.format(this.options.viewformat) : "";
          t(i).text(n);
        },
        html2value: function (t) {
  ...
  (function (t) {
    ...
    t.extend(t.fn.editableform.Constructor.prototype, {
      ...
      (t.fn.editableform.buttons =
        '<button type="submit" class="btn blue editable-submit"><i class="fa fa-check"></i></button><button type="button" class="btn default editable-cancel"><i class="fa fa-times"></i></button>'),
      (t.fn.editableform.errorGroupClass = "has-error"),
      (t.fn.editableform.errorBlockClass = null);
  })(window.jQuery),
  (function (t) {
    "use strict";
    (t.fn.popover.defaults = t.fn.popover.Constructor.DEFAULTS),
      t.extend(t.fn.editableContainer.Popup.prototype, {
        containerName: "popover",
        containerDataName: "bs.popover",
        innerCss:
          t.fn.popover && t(t.fn.popover.defaults.template).find("p").length
            ? ".popover-content p"
            : ".popover-content",
        initContainer: function () {
          t.extend(this.containerOptions, {
            ...
            selector: !1,
            content: " ",
            template: t.fn.popover.defaults.template,
          });
          var e;
          this.$element.data("template") &&
            ((e = this.$element.data("template")),
        ...
        setPosition: function () {
          !function () {
            ...
            switch (
              ...
              (c = { top: i.top + i.height / 2 - o / 2, left: i.left - n }),
              (h = {
              ...
              case "bottom":
                l.top + o > t(window).scrollTop() + t(window).height() &&
                  (r =
                    a.top > t(window).scrollTop()
                      ? "top"
                      : h.left + n < t(window).scrollLeft() + t(window).width()
                      ? "right"
                      : c.left > t(window).scrollLeft()
                      ? "left"
                      : "right");
                break;
              case "top":
              ...
              case "right":
                h.left + n > t(window).scrollLeft() + t(window).width() &&
                  (c.left > t(window).scrollLeft()
                    ...
                    : a.top > t(window).scrollTop()
                    ? (r = "top")
                    : a.top > t(window).scrollTop() && (r = "bottom"));
            }
            switch (r) {
              case "bottom":
                s = l;
            ...
            d.offset(s).addClass(r).addClass("in");
          }.call(this.container());
        },
      });
  })(window.jQuery),
  (function (t) {
    ...
    o.prototype = {
      ...
      _process_options: function (e) {
        ...
        var i = (this.o = t.extend({}, this._o)),
          n = i.language;
        switch (
          (h[n] || ((n = n.split("-")[0]), h[n] || (n = l.language)),
          (i.language = n),
          i.startView)
        ) {
          case 2:
        ...
        var o = d.parseFormat(i.format);
        i.startDate !== -1 / 0 &&
          (i.startDate = d.parseDate(i.startDate, o, i.language)),
          1 / 0 !== i.endDate &&
            (i.endDate = d.parseDate(i.endDate, o, i.language)),
              ...
              t(document),
              {
                mousedown: t.proxy(function (t) {
                  this.element.is(t.target) ||
                    this.element.find(t.target).size() ||
                    this.picker.is(t.target) ||
                    this.picker.find(t.target).size() ||
                    this.hide();
                }, this),
              },
            ],
      ...
      _trigger: function (e, i) {
        var n = i || this.date,
          o = new Date(n.getTime() + 6e4 * n.getTimezoneOffset());
        this.element.trigger({
          type: e,
          date: o,
          format: t.proxy(function (t) {
            var e = t || this.o.format;
            return d.formatDate(n, e, this.o.language);
          }, this),
        });
      },
      show: function (t) {
      ...
      getFormattedDate: function (t) {
        return (
          ...
          d.formatDate(this.date, t, this.o.language)
        );
      },
      ...
      update: function () {
        if (this._allow_update) {
          ...
          ("string" == typeof arguments[0] || arguments[0] instanceof Date)
            ...
            (this.date = d.parseDate(t, this.o.format, this.o.language)),
            e && this.setValue(),
            (this.viewDate =
      ...
      fillDow: function () {
        ...
        for (; t < this.o.weekStart + 7; )
          e +=
            '<th class="dow">' + h[this.o.language].daysMin[t++ % 7] + "</th>";
      ...
      fill: function () {
        ...
        this.date && this.date.valueOf(),
          this.picker
            ...
            .text(h[this.o.language].months[r] + " " + o),
          this.picker
            .find("tfoot th.today")
            .text(h[this.o.language].today)
            .toggle(this.o.todayBtn !== !1),
          this.picker
            .find("tfoot th.clear")
            .text(h[this.o.language].clear)
            .toggle(this.o.clearBtn !== !1),
          this.updateNavArrows(),
          this.fillMonths();
        var u = e(o, r - 1, 28, 0, 0, 0, 0),
          p = d.getDaysInMonth(u.getUTCFullYear(), u.getUTCMonth());
        u.setUTCDate(p),
        ...
        for (var g, m = []; u.valueOf() < f; ) {
          if (
            ...
            var v = new Date(
                +u + 864e5 * ((this.o.weekStart - u.getUTCDay() - 7) % 7)
              ),
              y = new Date(+v + 864e5 * ((11 - v.getUTCDay()) % 7)),
              b = new Date(
                +(b = e(y.getUTCFullYear(), 0, 1)) +
                  864e5 * ((11 - b.getUTCDay()) % 7)
              ),
              x = (y - b) / 864e5 / 7 + 1;
          ...
          void 0 === w
            ...
            : "boolean" == typeof w
            ? (w = { enabled: w })
            : "string" == typeof w && (w = { classes: w }),
            w.enabled === !1 && g.push("disabled"),
            w.classes && (g = g.concat(w.classes.split(/\s+/))),
            w.tooltip && (i = w.tooltip),
            (g = t.unique(g)),
            m.push(
              '<td class="' +
                g.join(" ") +
        ...
        var _ = this.date && this.date.getUTCFullYear(),
          C = this.picker
            ...
            .find("span")
            .removeClass("active");
        _ && _ == o && C.eq(this.date.getUTCMonth()).addClass("active"),
          (s > o || o > l) && C.addClass("disabled"),
          o == s && C.slice(0, a).addClass("disabled"),
          o == l && C.slice(c + 1).addClass("disabled"),
          (m = ""),
      ...
      moveMonth: function (t, e) {
        ...
        if (((e = e > 0 ? 1 : -1), 1 == a))
          ...
          for (var l = 0; a > l; l++) o = this.moveMonth(o, e);
          (i = o.getUTCMonth()),
            o.setUTCDate(r),
            (n = function () {
            ...
            (e = 37 == t.keyCode ? -1 : 1),
              t.ctrlKey
                ? ((i = this.moveYear(this.date, e)),
                  (n = this.moveYear(this.viewDate, e)))
                : t.shiftKey
                ? ((i = this.moveMonth(this.date, e)),
                  (n = this.moveMonth(this.viewDate, e)))
                : ((i = new Date(this.date)),
                  i.setUTCDate(this.date.getUTCDate() + e),
                  (n = new Date(this.viewDate)),
                  n.setUTCDate(this.viewDate.getUTCDate() + e)),
            ...
            (e = 38 == t.keyCode ? -1 : 1),
              t.ctrlKey
                ...
                ? ((i = this.moveMonth(this.date, e)),
                  (n = this.moveMonth(this.viewDate, e)))
                : ((i = new Date(this.date)),
                  i.setUTCDate(this.date.getUTCDate() + 7 * e),
                  (n = new Date(this.viewDate)),
                  n.setUTCDate(this.viewDate.getUTCDate() + 7 * e)),
              this.dateWithinRange(i) &&
                ((this.date = i),
                (this.viewDate = n),
                this.setValue(),
      ...
      showMode: function (t) {
        t &&
          ...
          this.picker
            .find(">div")
            .hide()
            .filter(".datepicker-" + d.modes[this.viewMode].clsName)
            .css("display", "block"),
          this.updateNavArrows();
      },
    };
    ...
    var s = t.fn.datepicker,
          ...
          this.each(function () {
            ...
            if (!h) {
              var u = i(this, "date"),
                ...
                f = n(p.language),
                g = t.extend({}, l, f, u, d);
              if (c.is(".input-daterange") || g.inputs) {
                var m = { inputs: g.inputs || c.find("input").toArray() };
                c.data("datepicker", (h = new r(this, t.extend(g, m))));
              } else c.data("datepicker", (h = new o(this, g)));
            }
            return "string" == typeof e &&
              "function" == typeof h[e] &&
              ((a = h[e].apply(h, s)), void 0 !== a)
              ? !1
              : void 0;
          }),
          void 0 !== a ? a : this
      ...
      c = (t.fn.datepicker.locale_opts = ["format", "rtl", "weekStart"]);
    ...
    var h = (t.fn.datepicker.dates = {
      ...
      d = {
        ...
        parseDate: function (i, n, r) {
          ...
          if (
            ...
            for (var u = 0; u < c.length; u++)
              switch (((s = l.exec(c[u])), (a = parseInt(s[1])), s[2])) {
                case "d":
                  i.setUTCDate(i.getUTCDate() + a);
                  break;
                case "m":
                  i = o.prototype.moveMonth.call(o.prototype, i, a);
                  break;
                case "w":
          ...
          (v.M = v.MM = v.mm = v.m),
            (v.dd = v.d),
            (i = e(i.getFullYear(), i.getMonth(), i.getDate(), 0, 0, 0));
          var y = n.parts.slice();
          if (
            (c.length != y.length &&
              (y = t(y)
            ...
            for (var u = 0, b = y.length; b > u; u++) {
              if (((p = parseInt(c[u], 10)), (s = y[u]), isNaN(p)))
                switch (s) {
                  case "MM":
                  ...
                  case "M":
                    (f = t(h[r].monthsShort).filter(function () {
                      ...
                      (p = t.inArray(f[0], h[r].monthsShort) + 1);
                }
              g[s] = p;
            }
        ...
        headTemplate:
          '<thead><tr><th class="prev"><i class="fa fa-angle-left"/></th><th colspan="5" class="datepicker-switch"></th><th class="next"><i class="fa fa-angle-right"/></th></tr></thead>',
      ...
      t.extend(e.prototype, {
        ...
        render: function () {
          this.$input.bdatepicker(this.options.datepicker),
            this.options.clear &&
              ...
              this.$tpl
                .parent()
                .append(t('<div class="editable-clear">').append(this.$clear)));
        },
        ...
        autosubmit: function () {
          this.$input.on("mouseup", ".day", function (e) {
            if (
              !t(e.currentTarget).is(".old") &&
              !t(e.currentTarget).is(".new")
            ) {
        ...
        parseDate: function (t, e) {
          ...
          return (
            t &&
              ((n = this.dpg.parseDate(t, e, this.options.datepicker.language)),
              "string" == typeof t &&
                ((i = this.dpg.formatDate(
                  n,
                  e,
                  this.options.datepicker.language
                )),
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput),
      t.extend(e.prototype, {
        initPicker: function (e, i) {
          this.options.viewformat ||
            (this.options.viewformat = this.options.format),
            (e.datetimepicker = t.fn.editableutils.tryParseJson(
              e.datetimepicker,
              !0
            )),
        ...
        value2html: function (t, i) {
          var n = t
            ...
            : "";
          return i ? (e.superclass.value2html(n, i), void 0) : n;
        },
        html2value: function (t) {
  ...
  (function (t) {
    "use strict";
    var e = function (i) {
      this.init("typeahead", i, e.defaults),
        (this.options.typeahead = t.extend(
          {},
          e.defaults.typeahead,
          {
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.list),
      t.extend(e.prototype, {
        renderList: function () {
          ...
          var e = this.$input.data("typeahead");
          (e.render = t.proxy(this.typeaheadRender, e)),
            (e.select = t.proxy(this.typeaheadSelect, e)),
            (e.move = t.proxy(this.typeaheadMove, e)),
            this.renderClear(),
            this.setClass(),
            this.setAttr("placeholder");
        },
        value2htmlFinal: function (e, i) {
          if (this.getIsObjects()) {
            var n = t.fn.editableutils.itemsByValue(e, this.sourceData);
            t(i).text(n.length ? n[0].text : "");
          } else t(i).text(e);
        },
        html2value: function (t) {
          return t ? t : null;
        ...
        value2input: function (e) {
          if (this.getIsObjects()) {
            var i = t.fn.editableutils.itemsByValue(e, this.sourceData);
            this.$input.data("value", e).val(i.length ? i[0].text : "");
          } else this.$input.val(e);
        },
        input2value: function () {
          if (this.getIsObjects()) {
            var e = this.$input.data("value"),
              i = t.fn.editableutils.itemsByValue(e, this.sourceData);
            return i.length &&
              i[0].text.toLowerCase() === this.$input.val().toLowerCase()
              ? e
              : null;
          }
          return this.$input.val();
        ...
        activate: t.fn.editabletypes.text.prototype.activate,
        renderClear: t.fn.editabletypes.text.prototype.renderClear,
        postrender: t.fn.editabletypes.text.prototype.postrender,
        toggleClear: t.fn.editabletypes.text.prototype.toggleClear,
        clear: function () {
          t.fn.editabletypes.text.prototype.clear.call(this),
            this.$input.data("value", "");
        },
        matcher: function (e) {
          return t.fn.typeahead.Constructor.prototype.matcher.call(
            this,
            e.text
          );
        },
        ...
        highlighter: function (e) {
          return t.fn.typeahead.Constructor.prototype.highlighter.call(
            this,
            e.text
          );
        },
        ...
        typeaheadRender: function (e) {
          var i = this;
          return (
            (e = t(e).map(function (e, n) {
              return (
                (e = t(i.options.item).data("item", n)),
                e.find("a").html(i.highlighter(n)),
                e[0]
              );
            })),
            this.options.autoSelect && e.first().addClass("active"),
            this.$menu.html(e),
            this
          );
        },
        typeaheadSelect: function () {
          ...
          return (
            (this.options.autoSelect || t) &&
              this.$element.val(this.updater(t)).change(),
            this.hide()
          );
        },
        typeaheadMove: function (t) {
          if (this.shown) {
            switch (t.keyCode) {
              case 9:
              case 13:
      ...
      (t.fn.editabletypes.typeahead = e);
  })(window.jQuery);
