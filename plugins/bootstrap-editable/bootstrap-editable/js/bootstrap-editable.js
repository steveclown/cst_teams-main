...
//                var h = this.$input.outerHeight(true) || 20,
  ...
  Text.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
    /**
        @property tpl 
        @default <input type="text" autocomplete="off" >
        **/
    tpl: '<input type="text" autocomplete="off" >',
    /**
  ...
  Combodate.prototype = {
    ...
    getTemplate: function () {
      ...
      $.each(this.map, function (k, v) {
        ...
        tpl = tpl.replace(
          "{" + token + "}",
          '<select class="form-control ' + k + '"></select>'
        );
      });
  ...
  Constructor.defaults = $.extend(
    ...
    $.fn.editabletypes.abstractinput.defaults,
    {
      /**
        ...
        @default <input type="text" autocomplete="off" >
        **/
      tpl: '<input type="text" autocomplete="off"  class="form-control">',
      /**
        @property inputclass 
        @default null
        **/
...
(function ($) {
  ...
  $.extend($.fn.editableContainer.Popup.prototype, {
    ...
    innerCss:
      $.fn.popover && $($.fn.popover.defaults.template).find("p").length
        ? ".popover-content p"
        : ".popover-content",
    ...
    setPosition: function () {
      (function () {
        ...
        switch (placement) {
          case "bottom":
            if (
              tpb.top + actualHeight >
              $(window).scrollTop() + $(window).height()
            ) {
              if (tpt.top > $(window).scrollTop()) {
                placement = "top";
              } else if (
                tpr.left + actualWidth <
...
(function ($) {
  ...
  Date.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
    ...
    /**
        ...
        **/
    clear:
      'clear <i class="icon-remove fa fa-times" style="font-size:12px"></i>',
  });
...
Shows normal <input type="text" autocomplete="off" > and binds popup datepicker.  
...
(function ($) {
  ...
  DateField.defaults = $.extend({}, $.fn.editabletypes.date.defaults, {
    /**
        @property tpl 
        **/
    tpl: '<div class="input-group input-group-fixed date"><input type="text" autocomplete="off"  readonly class="form-control input-medium pull-left"/><span class="input-group-btn pull-left"><button class="btn default" type="button"><i class="fa fa-calendar"></i></button></span></div>',
    /**
        @property inputclass 
        @default 'input-small'
        **/
...
Shows normal <input type="text" autocomplete="off" > and binds popup datetimepicker.  
Automatically shown in inline mode.
...
(function ($) {
  ...
  DateTimeField.defaults = $.extend({}, $.fn.editabletypes.datetime.defaults, {
    /**
        @property tpl 
        **/
    tpl: '<div class="input-group input-group-fixed date"><input type="text" autocomplete="off"  readonly class="form-control input-medium pull-left"/><span class="input-group-btn pull-left"><button class="btn date-set default" type="button"><i class="fa fa-calendar"></i></button></span></div>',
    /**
        @property inputclass 
        @default 'input-medium'
        **/
...
(function ($) {
  ...
  var Constructor = function (options) {
    ...
    //overriding objects in config (as by default jQuery extend() is not recursive)
    this.options.typeahead = $.extend(
      {},
      Constructor.defaults.typeahead,
      {
  ...
  $.extend(Constructor.prototype, {
    renderList: function () {
      this.$input = this.$tpl.is("input")
        ? this.$tpl
        : this.$tpl.find('input[type="text"]');
    ...
    input2value: function () {
      if (this.getIsObjects()) {
        ...
        if (
          items.length &&
          items[0].text.toLowerCase() === this.$input.val().toLowerCase()
        ) {
          return value;
        } else {
    ...
    highlighter: function (item) {
      return $.fn.typeahead.Constructor.prototype.highlighter.call(
        this,
        item.text
      );
    },
