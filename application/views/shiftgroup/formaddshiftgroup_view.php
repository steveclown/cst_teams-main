										...
										<div class="col-md-6">
											<div class="form-group">
												...
												*
												...
												<input type="text" autocomplete="off"  name="shift_group_code" id="shift_group_code" value="<?php echo $data['shift_group_code']?>" class="form-control" placeholder="Shift Group Code">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												*
												...
												<input type="text" autocomplete="off"  name="shift_group_name" id="shift_group_name" value="<?php echo $data['shift_group_name']?>" class="form-control" placeholder="Shift Group Name">
											</div>
										</div>
									</div>
