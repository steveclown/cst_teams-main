<script>
	function ulang(){
		document.getElementById("shift_group_code").value = "<?php echo $result['shift_group_code'] ?>";
		document.getElementById("shift_group_name").value = "<?php echo $result['shift_group_name'] ?>";
		document.getElementById("shift_id").value = "<?php echo $result['shift_id'] ?>";
		document.getElementById("shift_group_remark").value = "<?php echo $result['shift_group_remark'] ?>";
	}
</script>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<li>
						<a href="<?php echo base_url();?>shiftgroup/edit/<?php echo $result['shift_group_id'];?>">
							Edit Shift Group
						</a>
						<i class="fa fa-angle-right"></i>
					</li>
					...
					<div class="col-md-12">
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="form-body">
									<?php 
										echo form_open('shiftgroup/processEditShiftGroup',array('id' => 'myform', 'class' => 'horizontal-form')); 
									?>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												*
												...
												<textarea rows="3" name="shift_group_remark" id="shift_group_remark" class="form-control"><?php echo $result['shift_group_remark']?></textarea>
											</div>
										</div>
									</div>
										<input type="hidden" name="shift_group_id" value="<?php echo $result['shift_group_id']; ?>"/>
								</div>
