									...
									echo"
										<tr>			
											...
											<td>
												...
												<a href='".$this->config->item('base_url').'hroemployeeasset/deleteHROEmployeeAsset/'.$val['employee_id']."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
