...
<?php 
	...
	$applicanteducation_item	= $this->session->userdata("dataitemaddtransactionalapplicanteducation-".$header['created_on']);
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
													...
													foreach ($applicanteducation_item as $key=>$val){
														/* echo "
																<tr class='odd gradeX'>
																	...
																	<td>
																		<a href='".$this->config->item('base_url').'transactionalapplicanteducation/deletearrayapplicanteducationitem/'.$val[created_on].'/'.$val[education_id].'/'.$val[education_type]."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
														...
														echo "
																<tr class='odd gradeX'>
																	...
																	<td>$val[applicant_education_remark]</td>
																	<td>
																		<a href='".$this->config->item('base_url').'transactionalapplicanteducation/deletearrayapplicanteducationitem/'.$val[created_on].'/'.$key."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
																			<i class='fa fa-trash-o'></i> Delete
																		</a>
																	</td>
																</tr>
								...
								<div class="form-actions right">
									<a href="<?php echo base_url();?>transactionalapplicanteducation/resetapplicanteducation" class="btn red"><i class="fa fa-times"></i> Reset</a>
									<!-- <button type="submit" class="btn blue" onclick="return kings();"><i class="fa fa-check"></i> Save</button> -->
									<a href="<?php echo base_url();?>transactionalapplicantdata" class="btn dark button-previous"><i class="m-icon-swapleft"></i> Back</a>
