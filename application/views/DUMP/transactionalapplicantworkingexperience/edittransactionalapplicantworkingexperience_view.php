								...
								<div class="form-body">
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="working_experience_from_period" id="working_experience_from_period" value="<?php echo $result['working_experience_from_period'];?>" class="form-control" placeholder="From Period">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="working_experience_to_period" id="working_experience_to_period" value="<?php echo $result['working_experience_to_period'];?>" class="form-control" placeholder="To Period">
												<span class="help-block">
													 Please input only numbers.
												</span>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="working_experience_last_salary" id="working_experience_last_salary" value="<?php echo $result['working_experience_last_salary'];?>" class="form-control" placeholder="Last Salary">
												<span class="help-block">
													 Please input only numbers.
												</span>
											</div>
