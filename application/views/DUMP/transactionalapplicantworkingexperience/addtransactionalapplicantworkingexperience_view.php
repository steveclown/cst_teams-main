...
<?php 
	echo form_open('transactionalapplicantworkingexperience/arrayaddtransactionalapplicantworkingexperience',array('id' => 'myform', 'class' => 'form-horizontal')); 
	echo $this->session->userdata('message');
	$this->session->unset_userdata('message');
	$data = $this->session->userdata('addtransactionalapplicantworkingexperience');
?>
			<div class="row">
				<div class="col-md-12">
								...
								<div class="form-body">
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
											<textarea rows="5" name="company_address" id="company_address" class="form-control" placeholder="Working Experience Remark"><?php echo $data['company_address'];?></textarea>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
											<textarea rows="5" name="working_experience_resign_reason" id="working_experience_resign_reason" class="form-control" placeholder="Resign Reason"><?php echo $data['working_experience_resign_reason'];?></textarea>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
											<textarea rows="5" name="working_experience_remark" id="working_experience_remark" class="form-control" placeholder="Working Experience Remark"><?php echo $data['working_experience_remark'];?></textarea>
											</div>
										</div>
									</div>
								</div>
...
<?php echo form_close(); ?>
<?php $this->load->view('transactionalapplicantworkingexperience/arraytransactionalapplicantworkingexperience_view');?>