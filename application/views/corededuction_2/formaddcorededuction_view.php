					...
					<div class="col-md-12">
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<div class="form-body">
									<?php 
										echo form_open('corededuction/processAddArrayCoreDeductionAllowance',array('id' => 'myform', 'class' => 'horizontal-form')); 
									?>
									<div class = "row">
										<div class="col-md-6">
									...
									<div class="row">
										<div class="col-md-12" style='text-align:right'>
											<input type="submit" name="add2" id="buttonAddArrayCoreDeductionAllowance" value="Add" class="btn blue" title="Simpan Data" >
										</div>
									</div>
								</div>
