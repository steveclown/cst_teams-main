										...
										echo"
											<tr class='odd gradeX'>
												...
												<td style='text-align  : center !important;'>
													<a href='".base_url().'corededuction/deleteArrayDeductionAllowance/'.$val['created_on'].'/'.$val['allowance_id']."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
