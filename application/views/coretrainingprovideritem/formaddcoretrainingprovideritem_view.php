				...
				<div class="portlet-body form">
					<div class="form-body">
						...
						<div class = "row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" autocomplete="off"  name="training_provider_item_name" id="training_provider_item_name" value="<?php echo $data['training_provider_item_name'];?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" autocomplete="off"  name="training_provider_item_cost" id="training_provider_item_cost" value="<?php echo $data['training_provider_item_cost'];?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
						...
						<div class = "row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" autocomplete="off"  name="training_provider_item_duration" id="training_provider_item_duration" value="<?php echo $data['training_provider_item_duration'];?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
