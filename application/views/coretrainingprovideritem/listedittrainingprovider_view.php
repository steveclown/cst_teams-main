...
<?php
		$this->load->view('trainingprovider/edittrainingprovider_view');	 
?>
<?php 
	echo form_open('trainingprovider/processedittrainingprovider'); 
			...
			<table class="table table-bordered table-advance table-hover" style="margin-top:-15px !important;">
				...
				<?php
					if(!is_array($provider_item)){
						...
						foreach ($provider_item as $key=>$val){
...
<div class="col-md-12 " style="text-align  : right !important;">
	<input type="hidden" class="form-control" name="createdon" id="createdon" value="<?php echo $result['created_on'];?>">
