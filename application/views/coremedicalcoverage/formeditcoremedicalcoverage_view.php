			...
			<div class="portlet-body form">
				<div class="form-body">
					...
					<div class = "row">	
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" name="medical_coverage_code" id="medical_coverage_code" value="<?php echo $coremedicalcoverage['medical_coverage_code']?>" class="form-control">
						...
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" name="medical_coverage_name" id="medical_coverage_name" value="<?php echo $coremedicalcoverage['medical_coverage_name']?>" class="form-control" >
					...
					<div class = "row">
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" name="medical_coverage_ratio" id="medical_coverage_ratio" value="<?php echo $coremedicalcoverage['medical_coverage_ratio']?>" class="form-control" >
								<span class="help-block">
						...
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" name="medical_coverage_amount" id="medical_coverage_amount" value="<?php echo $coremedicalcoverage['medical_coverage_amount']?>" class="form-control">
								<span class="help-block">
									 Please input only numbers.
								</span>
