<script>
	...
	function reset_add_leave(){
		document.location = base_url+"hroemployeeadministration/reset_add_leave/<?php echo $hroemployeedata['employee_id']?>";
	}
...
<?php 
	echo form_open('hroemployeeadministration/processAddPayrollLeaveRequest',array('id' => 'myform', 'class' => 'horizontal-form')); 
...
<div class = "row">
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input class="form-control form-control-inline input-medium date-picker" data-date-format="dd-mm-yyyy" type="text" name="leave_request_date" id="leave_request_date" onChange="function_elements_add(this.name, this.value);" value="<?php echo tgltoview($dataleave['leave_request_date']);?>">
...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input class="form-control form-control-inline input-medium date-picker" data-date-format="dd-mm-yyyy" type="text" name="leave_request_start_date" id="leave_request_start_date" onChange="function_elements_add(this.name, this.value);" value="<?php echo tgltoview($dataleave['leave_request_start_date']);?>">
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input class="form-control form-control-inline input-medium date-picker" data-date-format="dd-mm-yyyy" type="text" name="leave_request_end_date" id="leave_request_end_date" onChange="function_elements_add(this.name, this.value);" value="<?php echo tgltoview($dataleave['leave_request_end_date']);?>">
...
<div class = "row">
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  name="leave_request_duration" id="leave_request_duration" value="<?php echo $dataleave['leave_request_duration']?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
...
<div class = "row">
	<div class = "col-md-12">
		<div class="form-group form-md-line-input">
			<textarea rows="3" name="leave_request_reason" id="leave_request_reason" class="form-control" onChange="function_elements_add(this.name, this.value);"><?php echo $dataleave['leave_request_reason'];?></textarea>
