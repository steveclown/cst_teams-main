<style>
	...
	<div class="row">
			<div class="col-md-12">
				...
				<h3 class="page-title">
				Hospital Coverage List for : <?php echo $this->transactionalhospitaladjustment_model->getemployeename($this->session->userdata("employee_id"));?>
				</h3>
								...
								foreach ($hospitalcoverage as $key=>$val){
									echo"
										<tr>									
											...
											<td>
												<a href='".$this->config->item('base_url').'transactionalhospitaladjustment/add/'.$val[employee_hospital_coverage_id]."' class='btn default btn-xs blue'>
