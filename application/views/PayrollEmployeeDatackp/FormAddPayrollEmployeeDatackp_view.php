<script>
	...
	function reset_add(){
		document.location = base_url+"PayrollEmployeeDatackp/reset_add/";
	}

	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('PayrollEmployeeDatackp/function_elements_add');?>",
	...
	function function_state_add(value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('PayrollEmployeeDatackp/function_state_add');?>",
				data : {'value' : value},
				success: function(msg){
			}
		});
		...
		margin-bottom: 12px !important;
					...
					<div class = "page-bar">
						<ul class="page-breadcrumb">
							...
							<li>
								<a href="<?php echo base_url();?>PayrollEmployeeDatackp/addPayrollEmployeeData/<?php echo $hroemployeedata['employee_id']?>">
					...
					<h3 class="page-title">
						Form Tambah data Gaji Karyawan - <?php echo $hroemployeedata['employee_name'];?> -
					</h3>
...
<?php
	...
	$data 		= $this->session->userdata('addpayrollemployeedatackp-'.$unique['unique']);
?>
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>PayrollEmployeeDatackp" class="btn btn-default sm">
						...
						<div class="tab-content">
							<?php
								...
								echo"<div class='tab-pane ".$statpayrollpayment."' id='tabpayrollpayment'>";
									$this->load->view("PayrollEmployeeDatackp/FormAddPayrollEmployeePayment_view");
								echo"</div>";

								echo"<div class='tab-pane ".$statpayrollallowance."' id='tabpayrollallowance'>";
									$this->load->view("PayrollEmployeeDatackp/FormAddPayrollEmployeeAllowance_view");
								echo"</div>";

								echo"<div class='tab-pane ".$statpayrolldeduction."' id='tabpayrolldeduction'>";
									$this->load->view("PayrollEmployeeDatackp/FormAddPayrollEmployeeDeduction_view");
								echo"</div>";

								echo"<div class='tab-pane ".$statpayrollpremiattendance."' id='tabpayrollpremiattendance'>";
									$this->load->view("PayrollEmployeeDatackp/FormAddPayrollEmployeePremiAttendance_view");
								echo"</div>";

								echo"<div class='tab-pane ".$statpayrollbpjs."' id='tabpayrollbpjs'>";
									$this->load->view("PayrollEmployeeDatackp/FormAddPayrollEmployeebpjs_view");
								echo"</div>";

								echo"<div class='tab-pane ".$statpayrollloan."' id='tabpayrollloan'>";
									$this->load->view("PayrollEmployeeDatackp/FormAddPayrollEmployeeLoan_view");
								echo"</div>";
							?>
						</div>
					</div>
