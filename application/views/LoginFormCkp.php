            ...
            <div class="row bs-reset">
                ...
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                        ...
                        <h1>TEAMS <br>Talent Management System</h1>
                        <p>Welcome to Talents Management System <br> <!-- Customized for PT. Cahaya Kharisma Plasindo --></p>
                        <form action="<?php echo base_url();?>validationprocessckp/loginValidate" class="login-form" method="post">
                        ...
                        <div class="row bs-reset">
                            <div class="col-xs-12 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Copyright &copy; <a href = "http://www.ciptasolutindo.id">CiptaSolutindo 2020</a>. Powered by Metronic Admin Template</p>
                                </div>
                            </div>
                        </div>
                    </div>
