<script>
    ...
    function processAddArrayIncentiveEmployeeOmzet(){
		...
		var employee_omzet_achievement	= document.getElementById("employee_omzet_achievement").value;
			...
			$('#onspinspinwarehouse').css('display', 'table-row');
			  ...
			  data: {
					...
					'employee_omzet_achievement' 	: employee_omzet_achievement, 
					'session_name' 					: "addarrayincentiverealizationdistribution-"
				},
			  success: function(msg){
			   window.location.replace(mappia);
										...
										foreach ($incentiveemployeeomzet as $key=>$val){
											echo"
												<tr>
													...
													<td style='text-align  : right !important;'>".number_format($val['employee_omzet_target'], 2)."</td>
													<td style='text-align  : right !important;'>".number_format($val['employee_omzet_achievement'], 2)."</td>
