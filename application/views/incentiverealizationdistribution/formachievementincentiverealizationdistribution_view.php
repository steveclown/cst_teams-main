							...
							<div class="portlet-body form">
								<div class="form-body">
									...
									<div class = "row">
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="branch_name" name="branch_name" readonly value="<?php echo $incentiverealizationdistribution['branch_name'];?>">
										...
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="location_name" name="location_name" readonly value="<?php echo $incentiverealizationdistribution['location_name'];?>">
