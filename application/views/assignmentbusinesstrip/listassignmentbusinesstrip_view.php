...
<?php echo form_open('assignmentbusinesstrip/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
								...
								foreach ($hroemployeedata_businesstrip as $key=>$val){
									...
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'assignmentbusinesstrip/addAssignmentBusinessTrip/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
