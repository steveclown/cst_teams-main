		...
		document.getElementById("leave_request_status").value = "<?php echo $result['leave_request_status'] ?>";
			...
			<div class="row">
				<div class="col-md-12">
					...
					<li>
						<a href="<?php echo base_url();?>transactionalleaverequestbybranch/edit/<?php echo $result['leave_request_id'];?>">
							Edit Leave Request
						</a>
						<i class="fa fa-angle-right"></i>
					</li>
					...
					<div class="col-md-12">
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="form-body">
									<?php 
										echo form_open('transactionalleaverequestbybranch/processEdittransactionalleaverequestbybranch',array('id' => 'myform', 'class' => 'form-horizontal')); 
									?>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<div class="input-group input-medium date date-picker" data-date="<?php echo date("d-m-Y");?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
													<input type="text" name="leave_request_start_date" id="leave_request_start_date" value="<?php echo tgltoview($result['leave_request_start_date'])?>" class="form-control" placeholder="Start Date" readonly>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<div class="input-group input-medium date date-picker" data-date="<?php echo date("d-m-Y");?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
													<input type="text" name="leave_request_end_date" id="leave_request_end_date" value="<?php echo tgltoview($result['leave_request_end_date'])?>" class="form-control" placeholder="End Date" readonly>
													<span class="input-group-btn">
														<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
													</span>
												</div>
