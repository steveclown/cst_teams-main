									...
									<div class="row">
										<div class="col-md-6">	
											<div class="form-group form-md-line-input">
												<input type="text" name="zone_code" id="zone_code" value="<?php echo $data['zone_code']?>" class="form-control" onChange="function_elements_add(this.name, this.value)" >
										...
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="zone_name" id="zone_name" value="<?php echo $data['zone_name']?>" class="form-control" onChange="function_elements_add(this.name, this.value)">
