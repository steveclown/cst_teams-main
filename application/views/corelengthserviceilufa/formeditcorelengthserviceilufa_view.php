				...
				<div class="portlet-body form">
					<div class="form-body">
						...
						<div class = "row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" name="length_service_amount" id="length_service_amount" class="form-control" value="<?php echo $corelengthservice['length_service_amount']?>" >
						...
						<div class = "row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" name="length_service_amount_multiply" id="length_service_amount_multiply" class="form-control" value="<?php echo $corelengthservice['length_service_amount_multiply']?>" >
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" name="length_service_min_saving" id="length_service_min_saving" class="form-control" value="<?php echo $corelengthservice['length_service_min_saving']?>" >
