						...
						<div class = "row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="religion_code" id="religion_code" class="form-control" value="<?php echo $result['religion_code']?>" >
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="religion_name" id="religion_name" class="form-control" value="<?php echo $result['religion_name']?>" >
								</div>
							</div>
						</div>
