<script>
	function ulang(){
		document.getElementById("expense_business_trip_name").value = "<?php echo $result[expense_business_trip_name]; ?>";
	}	
...
<div class="row">
	...
	<!-- BEGIN PAGE TITLE & BREADCRUMB-->
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li>
				<a href="<?php echo base_url();?>businesstrip/edit/<?php echo $result['training_schedule_id'];?>">
					Edit Business Trip
				</a>
				<i class="fa fa-angle-right"></i>
			</li>
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="form-body">
					<?php 
						echo form_open('businesstrip/processupdatebusinesstrip',array('id' => 'myform', 'class' => 'form-horizontal')); 
					?>
						<div class="form-group">
							<label class="col-md-3 control-label">Business Trip Name</label>
							<div class="col-md-8">
								<input type="text" autocomplete="off"  name="expense_business_trip_name" id="expense_business_trip_name" onChange="warningname(expense_business_trip_name);" value="<?php echo $result['expense_business_trip_name'];?>" class="form-control" placeholder="Business Trip Name">
							</div>
						</div>
				</div>
				<input type="hidden" name="expense_business_trip_id" value="<?php echo $result['expense_business_trip_id']; ?>"/>
