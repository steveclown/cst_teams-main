				...
				<div class="form-body">
					...
					?>
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" name="expense_business_trip_name" id="expense_business_trip_name" onChange="warningname(expense_business_trip_name);" value="<?php echo $result['expense_business_trip_name'];?>" class="form-control" placeholder="Business Trip Name">
							</div>
						</div>
				</div>
