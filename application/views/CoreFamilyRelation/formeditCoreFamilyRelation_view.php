						...
						<div class = "row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="family_relation_code" id="family_relation_code" value="<?php echo $CoreFamilyRelation['family_relation_code']?>" >
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="family_relation_name" id="family_relation_name" value="<?php echo $CoreFamilyRelation['family_relation_name']?>" >
