...
<script>
    ...
    function reset_filter(){
		document.location = base_url+"hroemployeetransfer/reset_search";
	}
</script>
...
?>
			...
			<h1 class="page-title">
				Employee Transfer List <small>Manage Employee Transfer</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php echo form_open('hroemployeetransfer/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
						...
						<tbody>
							<?php
								...
								foreach ($hroemployeedata_transfer as $key=>$val){
									/*<a href='".$this->config->item('base_url').'hroemployeetransfer/editHROEmployeeTransfer/'.$val['employee_id']."' class='btn default btn-xs purple'>
													<i class='fa fa-edit'></i> Edit
												</a>*/
									echo"
										<tr>			
											<td>".$no."</td>						
											<td>".$this->hroemployeetransfer_model->getEmployeeName($val['employee_id'])."</td>
											...
											<td>
												<a href='".$this->config->item('base_url').'hroemployeetransfer/addHROEmployeeTransfer/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
