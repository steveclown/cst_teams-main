...
<?php 
	echo form_open('addnewapplicant/processaddapplicantfamily',array('id' => 'myform', 'class' => 'form-horizontal')); 
	$sesi 		= $this->session->userdata('unique');
	$auth 		= $this->session->userdata('auth');
	$header		= $this->session->userdata('addapplicantfamily-'.$sesi['unique']);
	$applicantfamily_item	= $this->session->userdata("dataitemaddapplicantfamily-".$header['created_by']);
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
													...
													foreach ($applicantfamily_item as $key=>$val){
														...
														echo"
															<tr>									
																...
																<td>".$this->addnewapplicant_model->getmaritalstatusname($val[marital_status_id])."</td>
																<td>
																	<a href='".$this->config->item('base_url').'addnewapplicant/deletearrayapplicantfamilyitem/'.$key."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
								...
								<div class="form-actions right">
									<a href="<?php echo base_url();?>addnewapplicant/resetapplicantfamily" class="btn red"><i class="fa fa-times"></i> Reset</a>
									<!-- <button type="submit" class="btn blue" onclick="return kings();"><i class="fa fa-check"></i> Save</button> -->
									<a href="<?php echo base_url();?>addnewapplicant/applicanteducation" class="btn dark button-previous"><i class="m-icon-swapleft"></i> Back</a>
