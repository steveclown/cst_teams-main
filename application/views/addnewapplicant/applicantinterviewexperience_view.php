...
function ulang(){
	...
	document.getElementById("applicant_interview_experience_period").value = "";
	document.getElementById("applicant_interview_location").value = "";
	document.getElementById("applicant_interview_remark").value = "";
}
</script>
<?php 
	echo form_open('addnewapplicant/arrayaddapplicantinterviewexperience',array('id' => 'myform', 'class' => 'horizontal-form')); 
	echo $this->session->userdata('message');
	$this->session->unset_userdata('message');
	$data = $this->session->userdata('addapplicantinterviewexperience');
...
?>
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Add Data Applicant Wizard > Interview Experience
					</h3>
					...
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-reorder"></i>Interview Experience
								</div>
							</div>
							<div class="portlet-body form">
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" autocomplete="off"  name="applicant_interview_experience_period" id="applicant_interview_experience_period" value="<?php echo $data['applicant_interview_experience_period'];?>" class="form-control" placeholder="Period">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" autocomplete="off"  name="applicant_interview_location" id="applicant_interview_location" value="<?php echo $data['applicant_interview_location'];?>" class="form-control" placeholder="Location">
											</div>
										</div>
									</div>
									...
									<div class = "row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="col-md-3 control-label">Interview Experience Remark</label>
												
												<textarea rows="3" name="applicant_interview_remark" id="applicant_interview_remark" class="form-control" placeholder="Interview Experience Remark"><?php echo $data['applicant_interview_remark'];?></textarea>
											</div>
										</div>
									</div>
								</div>
...
<?php echo form_close(); ?>
<?php $this->load->view('addnewapplicant/arrayapplicantinterviewexperience_view');?>