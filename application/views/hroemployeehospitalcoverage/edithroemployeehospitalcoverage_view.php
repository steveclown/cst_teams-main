									...
									?>
										<div class="form-group">
											...
											*
											...
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="hospital_coverage_name" id="hospital_coverage_name" value="<?php echo $this->hroemployeehospitalcoverage_model->gethospitalcoveragename($result[hospital_coverage_id])?>" class="form-control" placeholder="Employee Name" readonly>
										...
										<div class="form-group">
											...
											*
											...
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="employee_name" id="employee_name" value="<?php echo $this->hroemployeehospitalcoverage_model->getemployeename($employee_id)?>" class="form-control" placeholder="Employee Name" readonly>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="hospital_coverage_period" id="hospital_coverage_period" value="<?php echo $result['hospital_coverage_period'];?>" class="form-control" placeholder="Coverage Period">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="hospital_coverage_amount" id="hospital_coverage_amount" value="<?php echo $result['hospital_coverage_amount'];?>" class="form-control" placeholder="Coverage Amount">
												<span class="help-block">
													 Please input only numbers.
												</span>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="hospital_coverage_claimed" id="hospital_coverage_claimed" value="<?php echo $result['hospital_coverage_claimed'];?>" class="form-control" placeholder="Coverage Claimed">
												<span class="help-block">
													 Please input only numbers.
												</span>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="hospital_coverage_last_balance" id="hospital_coverage_last_balance" value="<?php echo $result['hospital_coverage_last_balance'];?>" class="form-control" placeholder="Coverage Last Balance">
												<span class="help-block">
													 Please input only numbers.
												</span>
											</div>
