<style>
	...
	<div class="row">
			<div class="col-md-12">
				...
				<h3 class="page-title">
				Medical Coverage List for : <?php echo $this->transactionalmedicalclaim_model->getemployeename($this->session->userdata("employee_id"));?> 
				</h3>
						...
						<table class="table table-striped table-bordered table-hover table-full-width" id="sample_3">
							...
							<?php
								...
								foreach ($medicalcoverage as $key=>$val){
									echo"
										<tr>									
											<td>".$this->transactionalmedicalclaim_model->getmedicalcoveragename($val[medical_coverage_id])."</td>
											...
											<td>
												<a href='".$this->config->item('base_url').'transactionalmedicalclaim/add/'.$val[employee_medical_coverage_id]."' class='btn default btn-xs blue'>
