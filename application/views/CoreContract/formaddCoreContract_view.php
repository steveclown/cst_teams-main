									...
									<div class = "row">
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="contract_code" id="contract_code" value="<?php echo $data['contract_code'];?>" class="form-control">
										...
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="contract_name" id="contract_name" value="<?php echo $data['contract_name'];?>" class="form-control" >
