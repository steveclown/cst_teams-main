<script>
    ...
    function reset_filter(){
		document.location = base_url+"assignmentbusinesstripspa/reset_search";
	}
</script>
...
<?php echo form_open('assignmentbusinesstripspa/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
						...
						<tbody>
							<?php
								...
								foreach ($hroemployeedata_businesstrip as $key=>$val){
									/*<a href='".$this->config->item('base_url').'assignmentbusinesstripspa/editHROEmployeeAbsence/'.$val['employee_id']."' class='btn default btn-xs purple'>
									...
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'assignmentbusinesstripspa/addAssignmentBusinessTrip/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
