...
<script>
	function ulang(){
		...
		document.getElementById("paid_long_leave_total").value = "<?php echo $result['paid_long_leave_total'] ?>";
		document.getElementById("paid_long_leave_date").value = "<?php echo $result['paid_long_leave_date'] ?>";
		document.getElementById("paid_long_leave_remark").value = "<?php echo $result['paid_long_leave_remark'] ?>";
	}
	
</script>
<?php 
	echo form_open('trpaidlongleave/processEdittrpaidlongleave',array('id' => 'myform', 'class' => 'form-horizontal')); 
...
?>
			<div class="row">
				<div class="col-md-12">
					...
					<li>
						<a href="<?php echo base_url();?>trpaidlongleave/edit/<?php echo $result['paid_long_leave_id'];?>">
							Edit Paid Long Leave
						</a>
						<i class="fa fa-angle-right"></i>
					</li>
				</ul>
								...
								<div class="form-body">
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
											<textarea rows="5" name="paid_long_leave_remark" id="paid_long_leave_remark" class="form-control" placeholder="Remark"><?php echo $result['paid_long_leave_remark'];?></textarea>
											</div>
										</div>
									</div>
								</div>
				...
				<input type="hidden" name="paid_long_leave_id" value="<?php echo $result['paid_long_leave_id']; ?>"/>
<?php echo form_close(); ?>