<script>
    ...
    function reset_filter(){
		document.location = base_url+"payrollemployeesaving/reset_search";
	}
</script>
...
?>
			...
			<h1 class="page-title">
				Employee Saving List <small>Manage Employee Saving</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php echo form_open('payrollemployeesaving/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
						...
						<tbody>
							<?php
								$no=1;
								foreach ($hroemployeedata_saving as $key=>$val){
									/*<a href='".$this->config->item('base_url').'payrollemployeesaving/editPayrollEmployeeSaving/'.$val['employee_id']."' class='btn default btn-xs purple'>
									...
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'payrollemployeesaving/addPayrollEmployeeSaving/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
