<script>
    ...
    function reset_filter(){
		document.location = base_url+"payrollemployeeloanadisurya/reset_search";
	}
</script>
...
<?php echo form_open('payrollemployeeloanadisurya/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
								...
								foreach ($payrollemployeeloanrequisition as $key=>$val){
									...
									echo"
										<tr>			
											...
											<td>".$this->configuration->EmployeeLoanRequisitionApproval[$val['employee_loan_requisition_status']]."</td>
											<td>
												<a href='".$this->config->item('base_url').'payrollemployeeloanadisurya/addPayrollEmployeeLoanAdisurya/'.$val['employee_loan_requisition_id'].'/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
