<script>
    ...
    function reset_filter(){
		document.location = base_url+"hroemployeelate/reset_search";
	}
</script>
...
?>
			...
			<h1 class="page-title">
				Employee Late List <small>Manage Employee Late</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php echo form_open('hroemployeelate/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
						...
						<tbody>
							<?php
								$no=1;
								foreach ($hroemployeedata_late as $key=>$val){
									/*<a href='".$this->config->item('base_url').'hroemployeelate/editHROEmployeeLate/'.$val['employee_id']."' class='btn default btn-xs purple'>
									...
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'hroemployeelate/addHROEmployeeLate/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
