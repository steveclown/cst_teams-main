				...
				<div class="portlet-body form">
					<div class="form-body">
						<div class = "row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" autocomplete="off"  name="training_provider_code" id="training_provider_code" value="<?php echo $data['training_provider_code'];?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" autocomplete="off"  name="training_provider_name" id="training_provider_name" value="<?php echo $data['training_provider_name'];?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
						...
						<div class = "row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" autocomplete="off"  name="training_provider_city" id="training_provider_city" value="<?php echo $data['training_provider_city'];?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" autocomplete="off"  name="training_provider_home_phone" id="training_provider_home_phone" value="<?php echo $data['training_provider_home_phone'];?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
						...
						<div class = "row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" autocomplete="off"  name="training_provider_mobile_phone" id="training_provider_mobile_phone" value="<?php echo $data['training_provider_mobile_phone'];?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" autocomplete="off"  name="training_provider_fax_number" id="training_provider_fax_number" value="<?php echo $data['training_provider_fax_number'];?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
						...
						<div class = "row">
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" autocomplete="off"  name="training_provider_email" id="training_provider_email" value="<?php echo $data['training_provider_email'];?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" autocomplete="off"  name="training_provider_contact_person" id="training_provider_contact_person" value="<?php echo $data['training_provider_contact_person'];?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
