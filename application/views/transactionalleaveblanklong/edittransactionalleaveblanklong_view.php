										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<div class="input-group input-medium date date-picker" data-date="<?php echo date("d-m-Y");?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
													<input type="text" autocomplete="off"  name="leave_blank_long_date" id="leave_blank_long_date" value="<?php echo tgltoview($result['leave_blank_long_date'])?>" class="form-control" placeholder="Date" readonly>
