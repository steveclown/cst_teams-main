			...
			<div class="portlet-body">
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<div class="input-group input-medium date date-picker" data-date="<?php date("d-m-Y")?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
								<input type="text" autocomplete="off"  class="form-control" name="glasses_adjustment_date" value="<?php if($data[glasses_adjustment_date]=="")echo date('d-m-Y'); else echo tgltoview($data['glasses_adjustment_date']);?>" readonly>
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" autocomplete="off"  name="glasses_adjustment_amount_view" id="glasses_adjustment_amount_view" value="<?php echo nominal($data['glasses_coverage_amount']);?>" class="form-control" placeholder="Amount" onchange="check(this.value)">
