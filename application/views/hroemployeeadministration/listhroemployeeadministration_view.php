...
<script>
    ...
    function reset_filter(){
		document.location = base_url+"hroemployeeadministration/reset_search";
	}
	...
	$(document).ready(function(){
        $("#division_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>hroemployeeadministration/getCoreDepartment",
    ...
    $(document).ready(function(){
        $("#department_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>hroemployeeadministration/getCoreSection",
...
?>
			...
			<h1 class="page-title">
				Employee Administration List <small>Manage Employee Administration</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php 
	$data = $this->session->userdata('filter-hroemployeeadministration');
	echo form_open('hroemployeeadministration/filter',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
							...
							<div class="form-group form-md-line-input">
								<?php
									if (!empty($data['division_id'])){
										$coredepartment = create_double($this->hroemployeeadministration_model->getCoreDepartment($data['division_id']),'department_id','department_name');
							...
							<div class="form-group form-md-line-input">
								<?php
									if (!empty($data['department_id'])){
										$coresection = create_double($this->hroemployeeadministration_model->getCoreSection($data['department_id']),'section_id','section_name');
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
						...
						<tbody>
							<?php
								$no=1;
								foreach ($hroemployeedata_administration as $key=>$val){
									echo"
										<tr>			
											<td>".$no."</td>						
											...
											<td>
												<a href='".$this->config->item('base_url').'hroemployeeadministration/addHROEmployeeAdministration/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
