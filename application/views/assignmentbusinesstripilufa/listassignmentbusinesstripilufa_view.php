<script>
    ...
    function reset_filter(){
		document.location = base_url+"assignmentbusinesstripilufa/reset_search";
	}
</script>
			...
			<h1 class="page-title">
				Business Trip List <small>Manage Business Trip</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php echo form_open('assignmentbusinesstripilufa/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
						...
						<tbody>
							<?php
								$no=1;
								foreach ($hroemployeedata_businesstrip as $key=>$val){
									/*<a href='".$this->config->item('base_url').'assignmentbusinesstripilufa/editHROEmployeeAbsence/'.$val['employee_id']."' class='btn default btn-xs purple'>
									...
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'assignmentbusinesstripilufa/addAssignmentBusinessTrip/'.$val['employee_id']."/".$val['job_title_id']."' class='btn default btn-xs green-jungle'>
