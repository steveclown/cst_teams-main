...
function ulang(){
	...
	document.getElementById("leave_paid_long_total").value = "";
	document.getElementById("leave_paid_long_date").value = "";
	document.getElementById("leave_paid_long_remark").value = "";
}
</script>
					...
					<div class="col-md-12">
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="form-body">
									<?php 
										echo form_open('transactionalleavepaidlong/processaddtransactionalleavepaidlong',array('id' => 'myform', 'class' => 'form-horizontal')); 
										$data = $this->session->userdata('addtransactionalleavepaidlong');
									?>
