							...
							<div class="portlet-body form">
								<div class="form-body">
									...
									<div class = "row">
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="overtime_minute_range1" id="overtime_minute_range1" class="form-control" value="<?php echo $data['overtime_minute_range1']?>" >
										...
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="overtime_minute_range2" id="overtime_minute_range2" class="form-control" value="<?php echo $data['overtime_minute_range2']?>" >
									...
									<div class = "row">
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="overtime_minute_rounded" id="overtime_minute_rounded" class="form-control" value="<?php echo $data['overtime_minute_rounded']?>" >
