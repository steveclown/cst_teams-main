							...
							<div class="portlet-body form">
								<div class="form-body">
									...
									<div class = "row">
										...
										<div class = "col-md-2">
											<div class="form-group form-md-line-input">
												<input type="text" name="daily_period_include_bpjs" id="daily_period_include_bpjs" value="<?php echo $this->configuration->IncludeBPJS[$payrolldailyperiod['daily_period_include_bpjs']]?>" class="form-control" onChange="function_elements_add(this.name, this.value);" readonly>
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body display-hide form">
				<div class="form-body ">
					...
					<input type="hidden" name="employee_daily_premi_attendance_amount" value="<?php echo $payrollemployeedaily['employee_daily_premi_attendance_amount']; ?>"/>
