<script>
    ...
    function reset_filter(){
		document.location = base_url+"hroemployeepermit/reset_search";
	}
</script>
...
?>
			...
			<h1 class="page-title">
				Employee Permit List <small>Manage Employee Permit</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php echo form_open('hroemployeepermit/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
						...
						<tbody>
							<?php
								$no=1;
								foreach ($hroemployeedata_permit as $key=>$val){
									/*<a href='".$this->config->item('base_url').'hroemployeepermit/editHROEmployeePermit/'.$val['employee_id']."' class='btn default btn-xs purple'>
													<i class='fa fa-edit'></i> Edit
												</a>*/
									echo"
										<tr>			
											<td>".$no."</td>						
											<td>".$this->hroemployeepermit_model->getEmployeeName($val['employee_id'])."</td>
											<td>".$this->hroemployeepermit_model->getDivisionName($val['division_id'])."</td>
											<td>".$this->hroemployeepermit_model->getDepartmentName($val['department_id'])."</td>
											<td>".$this->hroemployeepermit_model->getSectionName($val['section_id'])."</td>
											<td>
												<a href='".$this->config->item('base_url').'hroemployeepermit/addHROEmployeePermit/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
