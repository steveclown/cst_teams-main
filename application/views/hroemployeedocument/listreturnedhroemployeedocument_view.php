...
<?php
$data=$this->session->userdata('filter-hroemployeedocumentreturn');
if(!is_array($data)){
		$data['employee_id'] 	= '';
	}
?>
<?php echo form_open('hroemployeedocument/filter_hroemployeedocumentreturn',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
							...
							foreach ($hroemployeedocument as $key=>$val){
								echo"
									<tr>
										...
										<td>
											<a href='".$this->config->item('base_url').'hroemployeedocument/addReturnedHroEmployeeDocument/'.$val['employee_document_id']."' class='btn default btn-xs green-jungle'>
