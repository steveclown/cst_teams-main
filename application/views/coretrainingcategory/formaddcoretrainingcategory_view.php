					...
					<div class = "row">
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" name="training_category_code" id="training_category_code" value="<?php echo $data['training_category_code'];?>" class="form-control" >
						...
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" name="training_category_name" id="training_category_name" value="<?php echo $data['training_category_name'];?>" class="form-control" >
