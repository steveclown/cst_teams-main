...
<?php
	$this->load->view('assignmentovertimerate/formeditassignmentovertimerate_view');		 
?>
<?php 
	echo form_open('assignmentovertimerate/processEditAssignmentOvertimeRate'); 
										...
										echo"
											<tr class='odd gradeX'>
												...
												<td style='text-align  : center !important;'>
													<a href='".base_url().'assignmentovertimerate/deleteEditArrayOvertimeRateTitle/'.$assignmentovertimerate['overtime_rate_id'].'/'.$val['overtime_rate_title_id']."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
