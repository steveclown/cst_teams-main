...
<script>
	...
	function reset_edit_education(){
		document.location = base_url+"hroemployeedatailufa/reset_edit_education/<?php echo $hroemployeedatailufa['employee_id']?>";
	}

	function function_elements_edit_education(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('hroemployeedatailufa/function_elements_edit_education');?>",
...
<?php 
	echo form_open('hroemployeedatailufa/processAddHROEmployeeEducation',array('id' => 'myform', 'class' => 'horizontal-form')); 
?>
...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  name="employee_education_name" id="employee_education_name" value="<?php echo $data['employee_education_name']?>" class="form-control" onChange="function_elements_edit_education(this.name, this.value);">
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  name="employee_education_city" id="employee_education_city" value="<?php echo $data['employee_education_city']?>" class="form-control" onChange="function_elements_edit_education(this.name, this.value);">
...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  name="employee_education_duration" id="employee_education_duration" value="<?php echo $data['employee_education_duration']?>" class="form-control" onChange="function_elements_edit_education(this.name, this.value);">
...
<input type="hidden" name="employee_id" id="employee_id" value="<?php echo $hroemployeedatailufa['employee_id']?>" class="form-control" onChange="function_elements_edit_education(this.name, this.value);">
						...
						foreach ($hroemployeeeducation as $key=>$val){
							echo"
								<tr>
									...
									<td>
									<a href='".$this->config->item('base_url').'hroemployeedatailufa/deleteHROEmployeeEducation/'.$hroemployeedatailufa['employee_id'].'/'.$val['employee_education_id']."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
