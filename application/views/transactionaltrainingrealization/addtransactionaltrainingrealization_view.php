...
<div class="row">
	<div class="col-md-12">
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li>
				<a href="#">
					Add Transactional Training Realization
				</a>
				<i class="fa fa-angle-right"></i>
			</li>
		</ul>
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				<div class="form-body">
					<?php 
						echo form_open('transactionaltrainingrealization/processaddtransactionaltrainingrealization',array('id' => 'myform', 'class' => 'form-horizontal')); 
