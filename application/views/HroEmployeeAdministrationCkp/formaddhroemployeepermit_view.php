...
<script>
	...
	function reset_add_permit(){
		document.location = base_url+"hroemployeeadministrationckp/reset_add_permit/<?php echo $employee_id; ?>/<?php echo $employee_absence_date; ?>/<?php echo $employee_schedule_item_id; ?>";
	}
...
<?php 
	echo form_open('hroemployeeadministrationckp/processAddHROEmployeePermit',array('id' => 'myform', 'class' => 'horizontal-form')); 
	...
	if (empty($datapermit)){
		$datapermit['employee_permit_date'] 		= $employee_absence_date;
	}
...
<div class = "row">		
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  class="form-control" id="employee_permit_date" name="employee_permit_date" onChange="function_elements_add_permit(this.name, this.value);" value="<?php echo tgltoview($datapermit['employee_permit_date']);?>" readonly>
...
<input type="hidden" name="employee_absence_date" value="<?php echo $employee_absence_date; ?>"/>
<input type="hidden" name="employee_schedule_item_id" value="<?php echo $employee_schedule_item_id; ?>"/>
<?php echo form_close(); ?>
						...
						foreach ($hroemployeepermit as $key=>$val){
							echo"
								<tr>
									...
									<td>
										<a href='".$this->config->item('base_url').'hroemployeeadministrationckp/deleteHROEmployeePermit/'.$val['employee_id']."/".$val['employee_permit_id']."/".$employee_absence_date."/".$employee_schedule_item_id."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
