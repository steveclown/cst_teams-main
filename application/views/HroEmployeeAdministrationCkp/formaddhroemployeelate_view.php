<script>
	...
	function reset_add_late(){
		document.location = base_url+"hroemployeeattendance/reset_add_late/<?php echo $hroemployeedata['employee_id']?>";
	}

	function function_elements_add_late(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('hroemployeeattendance/function_elements_add_late');?>",
...
<?php 
	echo form_open('hroemployeeattendance/processAddHROEmployeeLate',array('id' => 'myform', 'class' => 'horizontal-form')); 
...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="employee_late_description" name="employee_late_description" onChange="function_elements_add_late(this.name, this.value);" value="<?php echo $datalate['employee_late_description'];?>">
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="employee_late_duration" name="employee_late_duration" onChange="function_elements_add_late(this.name, this.value);" value="<?php echo $datalate['employee_late_duration'];?>">
						...
						foreach ($hroemployeelate as $key=>$val){
							echo"
								<tr>
									...
									<td>
										<a href='".$this->config->item('base_url').'hroemployeeattendance/deleteHROEmployeeLate/'.$val['employee_id']."/".$val['employee_late_id']."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
