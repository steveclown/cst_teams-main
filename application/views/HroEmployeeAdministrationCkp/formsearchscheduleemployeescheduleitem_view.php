...
?>
<?php echo form_open('hroemployeeadministrationckp/filterScheduleItem',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
			...
			<div class="portlet-body display-hide">
				<div class="form-body form">
					<div class = "row">
						...
						<input type="hidden" name="employee_id" id="employee_id" value="<?php echo $employee_id;?>" class="form-control"  onChange="function_elements_add(this.name, this.value);">
					</div>
								...
								foreach ($scheduleemployeescheduleitem as $key=>$val){
									echo"
										<tr>			
											...
											<td>".$this->configuration->ScheduleEmployeeScheduleItem[$val['employee_schedule_item_status']]."</td>
											<td>
												<a href='".$this->config->item('base_url').'hroemployeeadministrationckp/addHROEmployeeAdministration/'.$val['employee_id']."/".$val['employee_schedule_item_date']."/".$val['employee_schedule_item_id']."' class='btn default btn-xs green-jungle'>
