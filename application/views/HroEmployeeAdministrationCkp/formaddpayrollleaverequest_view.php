...
<script>
	...
	function reset_add_leave(){
		document.location = base_url+"hroemployeeadministrationckp/reset_add_leave/<?php echo $employee_id; ?>/<?php echo $employee_absence_date; ?>/<?php echo $employee_schedule_item_id; ?>";
	}
...
<?php 
	echo form_open('hroemployeeadministrationckp/processAddPayrollLeaveRequest',array('id' => 'myform', 'class' => 'horizontal-form')); 
	...
	$dataleave['leave_request_date'] 		= $employee_absence_date;
?>
						...
						foreach ($payrollleaverequest as $key=>$val){
							...
							echo"
								<tr>
									...
									<td>
										<a href='".$this->config->item('base_url').'hroemployeeadministrationckp/deletePayrollLeaveRequest/'.$val['employee_id']."/".$val['leave_request_id']."/".$employee_absence_date."/".$employee_schedule_item_id."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
