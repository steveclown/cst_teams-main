...
<script>
	...
	function reset_add_absence(){
		document.location = base_url+"hroemployeeadministrationckp/reset_add_absence/<?php echo $employee_id; ?>/<?php echo $employee_absence_date; ?>/<?php echo $employee_schedule_item_id; ?>";
	}

	function function_elements_add_absence(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('hroemployeeadministrationckp/function_elements_add_absence');?>",
...
<?php 
	echo form_open('hroemployeeadministrationckp/processAddHROEmployeeAbsence',array('id' => 'myform', 'class' => 'horizontal-form')); 
	...
	$dataabsence['employee_absence_date'] 		= $employee_absence_date;
	$dataabsence['employee_absence_start_date'] = $employee_absence_date;
	$dataabsence['employee_absence_end_date'] 	= $employee_absence_date;
						...
						foreach ($hroemployeeabsence as $key=>$val){
							echo"
								<tr>
									...
									<td>
										<a href='".$this->config->item('base_url').'hroemployeeadministrationckp/deleteHROEmployeeAbsence/'.$val['employee_id']."/".$val['employee_absence_id']."/".$employee_absence_date."/".$employee_schedule_item_id."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
