							...
							<div class="portlet-body form">
								<div class="form-body">
									...
									<div class = "row">
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="training_job_title_code" id="training_job_title_code" value="<?php echo $data['training_job_title_code']?>" class="form-control"  onChange="function_elements_add(this.name, this.value);">
										...
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="training_job_title_name" id="training_job_title_name" value="<?php echo $data['training_job_title_name']?>" class="form-control"  onChange="function_elements_add(this.name, this.value);">
