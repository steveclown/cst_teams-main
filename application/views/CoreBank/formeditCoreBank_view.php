					...
					<div class = "row">
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="bank_code" id="bank_code" value="<?php echo $CoreBank['bank_code'];?>" class="form-control" onChange="warningawardcode(award_code);">
						...
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="bank_name" id="bank_name" value="<?php echo $CoreBank['bank_name'];?>" class="form-control" onChange="warningawardcode(award_code);">
