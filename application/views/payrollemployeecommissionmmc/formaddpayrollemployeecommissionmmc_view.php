							...
							<div class="portlet-body form">
								<div class="form-body">
									...
									<div class = "row">
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  name="employee_commission_mmc_omzet" id="employee_commission_mmc_omzet" value="<?php echo $data['employee_commission_mmc_omzet']?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
