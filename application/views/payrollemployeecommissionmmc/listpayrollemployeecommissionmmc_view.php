<script>
    ...
    function reset_filter(){
		document.location = base_url+"payrollemployeecommissionmmc/reset_search";
	}
</script>
...
<?php echo form_open('payrollemployeecommissionmmc/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
						...
						<tbody>
							<?php
								$no=1;
								foreach ($hroemployeedata_commissionmmc as $key=>$val){
									/*<a href='".$this->config->item('base_url').'payrollemployeecommissionmmc/editPayrollEmployeeBonus/'.$val['employee_id']."' class='btn default btn-xs purple'>
									...
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'payrollemployeecommissionmmc/addPayrollEmployeeCommissionMMC/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
													<i class='fa fa-plus'></i> Add
												</a>
												<a href='".$this->config->item('base_url').'payrollemployeecommissionmmc/deletePayrollEmployeeCommissionMMC/'.$val['employee_id']."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
