			...
			<div class="portlet-body display-hide form">
				<div class="form-body ">
					<div class = "row">
						...
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="division_id" id="division_id" value="<?php echo $this->payrollmedicalclaim_model->getDivisionName($hroemployeedata['division_id'])?>" class="form-control" readonly>
					...
					<div class = "row">
						...
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="department_id" id="department_id" value="<?php echo $this->payrollmedicalclaim_model->getDepartmentName($hroemployeedata['department_id'])?>" class="form-control" readonly>
						...
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="section_id" id="section_id" value="<?php echo $this->payrollmedicalclaim_model->getSectionName($hroemployeedata['section_id'])?>" class="form-control" readonly>
			...
			<div class="portlet-body form">
				<div class="form-body">
					...
					<div class = "row">
						<div class = "col-md-12">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="medical_claim_description" id="medical_claim_description" value="<?php echo $data[medical_claim_description];?>" class="form-control">
					...
					<div class = "row">
						...
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="medical_claim_opening_balance_view" id="medical_claim_opening_balance_view" value="<?php echo nominal($data[medical_coverage_last_balance]);?>" class="form-control" readonly>
					...
					<div class = "row">
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="medical_claim_amount_view" id="medical_claim_amount_view" value="<?php echo $data['medical_claim_amount_view'];?>" class="form-control" onchange="calculateMedicalClaimAmount(this.value)">
						...
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="medical_claim_last_balance_view" id="medical_claim_last_balance_view" value="<?php echo nominal($data[medical_coverage_last_balance]);?>" class="form-control" readonly>
