								...
								<div class="form-body">
									...
									?>
										...
										<label class="control-label col-md-3">Claim Date</label>
											<div class="col-md-3">
														<div class="input-group input-medium date date-picker" data-date="<?php date("d-m-Y")?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
															<input type="text" class="form-control" name="medical_claim_date" value="<?php echo $result['medical_claim_date'];?>" readonly>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" name="medical_claim_opening_balance" id="medical_claim_opening_balance" value="<?php echo $result['medical_claim_opening_balance'];?>" class="form-control" placeholder="Opening Balance">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" name="medical_claim_amount" id="medical_claim_amount" value="<?php echo $result['medical_claim_amount'];?>" class="form-control" placeholder="Amount">
												<span class="help-block">
													 Please input only numbers.
												</span>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" name="medical_claim_last_balance" id="medical_claim_last_balance" value="<?php echo $result['medical_claim_last_balance'];?>" class="form-control" placeholder="Last Balance">
												<span class="help-block">
													 Please input only numbers.
												</span>
											</div>
