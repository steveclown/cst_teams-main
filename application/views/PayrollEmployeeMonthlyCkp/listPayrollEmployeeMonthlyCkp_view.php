...
<script>
    ...
    function reset_filter(){
		document.location = base_url+"PayrollEmployeeMonthlyCkp/reset_search";
	}
</script>
...
?>
				...
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>PayrollEmployeeMonthlyCkp">
							Daftar Bulanan Pegawai Payroll
						</a>
						<i class="fa fa-angle-right"></i>
					</li>
				</ul>
			...
			<h1 class="page-title">
				Daftar Bulanan Pegawai Payroll <small>Kelola Bulanan Pegawai Payroll</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php 
	echo form_open('PayrollEmployeeMonthlyCkp/filter',array('id' => 'myform', 'class' => '')); 
		...
		<div class="col-md-12">
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>PayrollEmployeeMonthlyCkp/addPayrollEmployeeMonthly" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i> Tambah Penggajian Karyawan Bulanan</a>
					</div>
				</div>
								...
								foreach ($payrollemployeemonthly as $key=>$val){
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'PayrollEmployeeMonthlyCkp/showdetail/'.$val['employee_monthly_id']."' class='btn default btn-xs yellow-lemon'>
