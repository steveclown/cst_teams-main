	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url(); ?>payroll-monthly-period/add" class="btn btn-default btn-sm">
						...
						foreach ($payrollmonthlyperiod as $key => $val) {
							echo "
										<tr>	
											...
											<td>
												<a href='" . $this->config->item('base_url') . 'payroll-monthly-period/delete/' . $val['monthly_period_id'] . "' onClick='javascript:return confirm(\"Apakah yakin ingin dihapus ?\")' class='btn default btn-xs red'>
