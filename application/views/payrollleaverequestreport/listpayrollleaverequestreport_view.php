<script>
    ...
    function reset_filter(){
		document.location = base_url+"payrollleaverequestreport/reset_search";
	}

	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('payrollleaverequestreport/function_elements_add');?>",
	...
	function function_state_add(value){
		...
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('payrollleaverequestreport/function_state_add');?>",
				data : {'value' : value},
				success: function(msg){
			}
		});
...
?>
			...
			<div class = "page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>payrollleaverequestreport">
							Payroll Leave Request Report List
						</a>
						<i class="fa fa-angle-right"></i>
					</li>
				</ul>
			...
			<h1 class="page-title">
				Employee Leave Request Report List <small>Manage Employee Leave Request Report</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php echo form_open('payrollleaverequestreport/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="form-body form">
					...
					<div class = "row">
						...
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
								<?php
									echo form_dropdown('annual_leave_id', $coreannualleave, set_value('annual_leave_id', $data['annual_leave_id']), 'id="annual_leave_id" class="form-control select2me" ');
								?>
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
						...
						<tbody>
							<?php
								$no=1;
								foreach ($payrollleaverequest_report as $key=>$val){
									echo"
										<tr>			
											<td>".$no."</td>						
											...
											<td>
												<a href='".$this->config->item('base_url').'payrollleaverequestreport/detailPayrollLeaveRequest/'.$val['leave_request_id']."' class='btn default btn-xs yellow-saffron'>
