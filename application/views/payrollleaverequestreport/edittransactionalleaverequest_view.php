								...
								<div class="form-body">
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<div class="input-group input-medium date date-picker" data-date="<?php echo date("Y-m-d");?>" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
													<input type="text" name="leave_request_start_date" id="leave_request_start_date" value="<?php echo $result['leave_request_start_date']?>" class="form-control" placeholder="Start Date" readonly>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<div class="input-group input-medium date date-picker" data-date="<?php echo date("Y-m-d");?>" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
													<input type="text" name="leave_request_end_date" id="leave_request_end_date" value="<?php echo $result['leave_request_end_date']?>" class="form-control" placeholder="End Date" readonly>
													<span class="input-group-btn">
														<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
													</span>
												</div>
