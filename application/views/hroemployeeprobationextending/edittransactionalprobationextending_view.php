								...
								<div class="form-body">
									...
									?>
										...
										<label class="control-label col-md-3">Date</label>
											<div class="col-md-3">
												<div class="input-group input-medium date date-picker" data-date="<?php date("d-m-Y")?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
													<input type="text" class="form-control" name="probation_extending_date" value="<?php echo tgltoview($result['probation_extending_date']);?>" readonly>
										...
										<label class="control-label col-md-3">Due Date</label>
											<div class="col-md-3">
												<div class="input-group input-medium date date-picker" data-date="<?php date("d-m-Y")?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
													<input type="text" class="form-control" name="probation_extending_due_date" value="<?php echo tgltoview($result['probation_extending_due_date']);?>" readonly>
													<span class="input-group-btn">
														<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
													</span>
												</div>
