		...
		<div class="col-md-12">
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>class/add" class="btn btn-default btn-sm">
								...
								foreach ($coreclass as $key=>$val){
									...
									echo"
										<tr>
											...
											<td>
												<a href='".$this->config->item('base_url').'class/edit/'.$val['class_id']."' class='btn default btn-xs purple'>
													<i class='fa fa-edit'></i> Edit
												</a>
												<a href='".$this->config->item('base_url').'lass/delete/'.$val['class_id']."' onClick='javascript:return confirm(\"Apakah Anda yakin akan menghapus data ini ?\")' class='btn default btn-xs red'>
