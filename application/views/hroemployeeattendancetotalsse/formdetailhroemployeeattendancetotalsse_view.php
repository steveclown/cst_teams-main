							...
							<div class="portlet-body form">
								<div class="form-body">
									...
									<div class = "row">
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  class="form-control" id="employee_shift_code" name="employee_shift_code"  value="<?php echo $hroemployeeattendancetotalsse['employee_shift_code'];?>" readonly>
										...
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  class="form-control" id="employee_monthly_period" name="employee_monthly_period"  value="<?php echo $hroemployeeattendancetotalsse['employee_monthly_period'];?>" readonly>
									...
									<div class = "row">
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  class="form-control" id="employee_monthly_start_date" name="employee_monthly_start_date"  value="<?php echo tgltoview($hroemployeeattendancetotalsse['employee_monthly_start_date']);?>" readonly>
										...
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  class="form-control" id="employee_monthly_end_date" name="employee_monthly_end_date"  value="<?php echo tgltoview($hroemployeeattendancetotalsse['employee_monthly_end_date']);?>" readonly>
