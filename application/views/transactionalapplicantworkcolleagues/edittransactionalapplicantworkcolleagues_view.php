								...
								<div class="form-body">
									...
									?>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" name="applicant_work_colleagues_name" id="applicant_work_colleagues_name" value="<?php echo $result['applicant_work_colleagues_name'];?>" class="form-control" placeholder="Colleague Name">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Section</label>
											<div class="col-md-8">
												<input type="text" name="applicant_work_colleagues_section" id="applicant_work_colleagues_section" value="<?php echo $result['applicant_work_colleagues_section'];?>" class="form-control" placeholder="Section">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Relationship</label>
											<div class="col-md-8">
												<input type="text" name="applicant_work_colleagues_relatioship" id="applicant_work_colleagues_relatioship" value="<?php echo $result['applicant_work_colleagues_relatioship'];?>" class="form-control" placeholder="Relationship">
											</div>
										</div>
								</div>
