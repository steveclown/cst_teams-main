...
<div class="row">
	<div class="col-md-6">
		<div class="form-group">
			...
			<?php
				echo form_dropdown('applicant_subjects_status', $status,set_value('applicant_subjects_status',$data['applicant_subjects_status']),'id="applicant_subjects_status" class="form-control"');
			?>
		</div>
	</div>
	<div class="col-md-6">
