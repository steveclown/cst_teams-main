...
<script>
    ...
    function reset_filter(){
		document.location = base_url+"payrollemployeedata/reset_search";
	}
	...
	$(document).ready(function(){
        $("#division_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>payrollemployeedata/getCoreDepartment",
    ...
    $(document).ready(function(){
        $("#department_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>payrollemployeedata/getCoreSection",
...
?>
			...
			<h1 class="page-title">
				Payroll Employee Data List <small>Manage Payroll Employee Data</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php 
	$data = $this->session->userdata('filter-payrollemployeedata');
	echo form_open('payrollemployeedata/filter', array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
							...
							<div class="form-group form-md-line-input">
								<?php
									if (!empty($data['division_id'])){
										$coredepartment = create_double($this->payrollemployeedata_model->getCoreDepartment($data['division_id']),'department_id','department_name');
							...
							<div class="form-group form-md-line-input">
								<?php
									if (!empty($data['department_id'])){
										$coresection = create_double($this->payrollemployeedata_model->getCoreSection($data['department_id']),'section_id','section_name');
