<style>
	...
	<div class="row">
			<div class="col-md-12">
				...
				<h3 class="page-title">
				Glasses Coverage List for : <?php echo $this->transactionalglassesclaim_model->getemployeename($this->session->userdata("employee_id"));?>
				</h3>
						...
						<table class="table table-striped table-bordered table-hover table-full-width" id="sample_3">
							...
							<?php
								...
								foreach ($glassescoverage as $key=>$val){
									echo"
										<tr>									
											<td>".$this->transactionalglassesclaim_model->getglassescoveragename($val[glasses_coverage_id])."</td>
											...
											<td>
												<a href='".$this->config->item('base_url').'transactionalglassesclaim/add/'.$val[employee_glasses_coverage_id]."' class='btn default btn-xs blue'>
