							...
							<div class="portlet-body form">
								<div class="form-body">
									...
									<div class = "row">
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="employee_loan_description" id="employee_loan_description" value="<?php echo $data['employee_loan_description']?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
									...
									<div class = "row">
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="employee_loan_amount_total" id="employee_loan_amount_total" value="<?php echo $data['employee_loan_amount_total']?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
										...
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="employee_loan_amount" id="employee_loan_amount" value="<?php echo $data['employee_loan_amount']?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
