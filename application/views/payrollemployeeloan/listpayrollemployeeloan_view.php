<script>
    ...
    function reset_filter(){
		document.location = base_url+"payrollemployeeloan/reset_search";
	}
</script>
...
<?php echo form_open('payrollemployeeloan/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
						...
						<tbody>
							<?php
								$no=1;
								foreach ($hroemployeedata_loan as $key=>$val){
									...
									echo"
										<tr>			
											<td>".$no."</td>						
											<td>".$this->payrollemployeeloan_model->getEmployeeName($val['employee_id'])."</td>
											<td>".$this->payrollemployeeloan_model->getDivisionName($val['division_id'])."</td>
											<td>".$this->payrollemployeeloan_model->getDepartmentName($val['department_id'])."</td>
											<td>".$this->payrollemployeeloan_model->getSectionName($val['section_id'])."</td>
											<td>
												<a href='".$this->config->item('base_url').'payrollemployeeloan/addPayrollEmployeeLoan/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
