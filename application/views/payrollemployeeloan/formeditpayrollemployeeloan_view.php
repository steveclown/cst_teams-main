					...
					<div class="form-body">
						...
						?>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" name="employee_loan_description" id="employee_loan_description" value="<?php echo $result['employee_loan_description'];?>" class="form-control" placeholder="Loan Description">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Installment Payment Period</label>
								<div class="col-md-8">
									<input type="text" name="installment_payment_period" id="installment_payment_period" value="<?php echo $result['installment_payment_period'];?>" class="form-control" placeholder="Installment Payment Period">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Installment Payment Total</label>
								<div class="col-md-8">
									<input type="text" name="installment_payment_total" id="installment_payment_total" value="<?php echo $result['installment_payment_total'];?>" class="form-control" placeholder="Installment Payment Total">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Loan Amount Total</label>
								<div class="col-md-8">
									<input type="text" name="employee_loan_amount_total" id="employee_loan_amount_total" value="<?php echo $result['employee_loan_amount_total'];?>" class="form-control" placeholder="Loan Amount Total">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Loan Amount</label>
								<div class="col-md-8">
									<input type="text" name="employee_loan_amount" id="employee_loan_amount" value="<?php echo $result['employee_loan_amount'];?>" class="form-control" placeholder="Loan Amount">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" name="period" id="period" value="<?php echo $result['period'];?>" class="form-control" placeholder="Period">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Installment Payment</label>
								<div class="col-md-8">
									<input type="text" name="installment_payment" id="installment_payment" value="<?php echo $result['installment_payment'];?>" class="form-control" placeholder="Installment Payment">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Loan Amount</label>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" name="employee_loan_payment" id="employee_loan_payment" value="<?php echo $result['employee_loan_payment'];?>" class="form-control" placeholder="Loan Payment">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Loan Balance</label>
								<div class="col-md-8">
									<input type="text" name="employee_loan_balance" id="employee_loan_balance" value="<?php echo $result['employee_loan_balance'];?>" class="form-control" placeholder="Loan Balance">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-3">
									<div class="input-group input-medium date date-picker" data-date="<?php echo date("d-m-Y");?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
										<input type="text" class="form-control" name="payment_date" id="payment_date" value="<?php echo tgltoview($result['payment_date']);?>" readonly>
