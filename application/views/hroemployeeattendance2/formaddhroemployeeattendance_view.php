				...
				<div class="form-body">
					<div class="tabbable-line boxless tabbable-reversed ">
						<ul class="nav nav-tabs">
							<?php
								if($data['active_tab']=="" || $data['active_tab']=="employeelate"){
						...
						<div class="tab-content">
							<?php
								...
								echo"<div class='tab-pane ".$statemployeelate."' id='tabemployeelate'>";
									$this->load->view("hroemployeeattendance/formaddhroemployeelate_view");
								echo"</div>";

								echo"<div class='tab-pane ".$statemployeepermit."' id='tabemployeepermit'>";
									$this->load->view("hroemployeeattendance/formaddhroemployeepermit_view");
								echo"</div>";

								echo"<div class='tab-pane ".$statemployeeabsence."' id='tabemployeeabsence'>";
									$this->load->view("hroemployeeattendance/formaddhroemployeeabsence_view");
								echo"</div>";

								echo"<div class='tab-pane ".$statemployeeovertime."' id='tabemployeeovertime'>";
									$this->load->view("hroemployeeattendance/formaddpayrollovertimerequest_view");
								echo"</div>";

								echo"<div class='tab-pane ".$statemployeeleave."' id='tabemployeeleave'>";
									$this->load->view("hroemployeeattendance/formaddpayrollleaverequest_view");
								echo"</div>";
							?>
						</div>
					</div>
