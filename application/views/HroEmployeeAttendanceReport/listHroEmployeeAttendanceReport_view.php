...
<script>
    ...
    function reset_filter(){
		document.location = base_url+"HroEmployeeAttendanceReport/reset_search";
	}

	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('HroEmployeeAttendanceReport/function_elements_add');?>",
	...
	$(document).ready(function(){
        $("#location_id").change(function(){
			var location_id 	= $("#location_id").val();
				...
				$.ajax({
					type: "POST",
					url : "<?php echo site_url('HroEmployeeAttendanceReport/getScheduleEmployeeShift');?>",
			...
			<div class = "page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="HroEmployeeAttendanceReport">
...
<?php 
	echo form_open('HroEmployeeAttendanceReport/filter',array('id' => 'myform', 'class' => '')); 
	$auth = $this->session->userdata('auth');
	$data = $this->session->userdata('filter-HroEmployeeAttendanceReport');
...
<?php
	echo form_open('HroEmployeeAttendanceReport/processPrinting'); 
?>
<div class="row">
		<div class="col-md-12">
			<div class="portlet box blue">
				...
				<div class="portlet-body">
					...
					<div class="row">
						<div class="col-md-12 " style="text-align  : right !important;">
							<a href='javascript:void(window.open("<?php echo base_url(); ?>HroEmployeeAttendanceReport/exportHROEmployeeAttendanceReport","_blank","top=100,left=200,width=300,height=300"));' class="btn green-jungle" title="Export to Excel">
