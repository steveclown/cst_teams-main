<script>
    ...
    function reset_filter(){
		document.location = base_url+"hroemployeepermitreport/reset_search";
	}

	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('hroemployeepermitreport/function_elements_add');?>",
	...
	function function_state_add(value){
		...
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('hroemployeepermitreport/function_state_add');?>",
				data : {'value' : value},
				success: function(msg){
			}
		});
...
?>
			...
			<div class = "page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>hroemployeepermitreport">
							Employee Permit Report List
						</a>
						<i class="fa fa-angle-right"></i>
					</li>
				</ul>
			...
			<h1 class="page-title">
				Employee Permit Report List <small>Manage Employee Permit Report</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php echo form_open('hroemployeepermitreport/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="form-body form">
					...
					<div class = "row">
						...
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
								<?php
									echo form_dropdown('permit_id', $corepermit, set_value('permit_id', $data['permit_id']), 'id="permit_id" class="form-control select2me" ');
								?>
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
						...
						<tbody>
							<?php
								$no=1;
								foreach ($hroemployeepermit_report as $key=>$val){
									echo"
										<tr>			
											<td>".$no."</td>						
											...
											<td>
												<a href='".$this->config->item('base_url').'hroemployeepermitreport/detailHROEmployeePermit/'.$val['employee_permit_id']."' class='btn default btn-xs yellow-saffron'>
