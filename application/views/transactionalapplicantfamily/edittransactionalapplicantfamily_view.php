								...
								<div class="form-body">
									...
									?>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_name" id="applicant_family_name" value="<?php echo $result['applicant_family_name'];?>" class="form-control" placeholder="Applicant Family Name">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">address</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_address" id="applicant_family_address" value="<?php echo $result['applicant_family_address'];?>" class="form-control" placeholder="address">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">City</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_city" id="applicant_family_city" value="<?php echo $result['applicant_family_city'];?>" class="form-control" placeholder="City">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Zip Code</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_zip_code" id="applicant_family_zip_code" value="<?php echo $result['applicant_family_zip_code'];?>" class="form-control" placeholder="Zip Code">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">RT</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_rt" id="applicant_family_rt" value="<?php echo $result['applicant_family_rt'];?>" class="form-control" placeholder="RT">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">RW</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_rw" id="applicant_family_rw" value="<?php echo $result['applicant_family_rw'];?>" class="form-control" placeholder="RW">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Kecamatan</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_kecamatan" id="applicant_family_kecamatan" value="<?php echo $result['applicant_family_kecamatan'];?>" class="form-control" placeholder="Kecamatan">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Kelurahan</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_kelurahan" id="applicant_family_kelurahan" value="<?php echo $result['applicant_family_kelurahan'];?>" class="form-control" placeholder="Kelurahan">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Home Phone</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_home_phone" id="applicant_family_home_phone" value="<?php echo $result['applicant_family_home_phone'];?>" class="form-control" placeholder="Home Phone">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Mobile Phone 1</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_mobile_phone1" id="applicant_family_mobile_phone1" value="<?php echo $result['applicant_family_mobile_phone1'];?>" class="form-control" placeholder="Mobile Phone 1">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Mobile Phone 2</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_mobile_phone2" id="applicant_family_mobile_phone2" value="<?php echo $result['applicant_family_mobile_phone2'];?>" class="form-control" placeholder="Mobile Phone 2">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group input-medium date date-picker" data-date="<?php echo date("d-m-Y");?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
													<input type="text" autocomplete="off"  name="applicant_family_date_of_birth" class="form-control" value="<?php echo tgltoview($result['applicant_family_date_of_birth'])?>" readonly>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_place_of_birth" id="applicant_family_place_of_birth" value="<?php echo $result['applicant_family_place_of_birth'];?>" class="form-control" placeholder="Place Of Birth">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Education</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_education" id="applicant_family_education" value="<?php echo $result['applicant_family_education'];?>" class="form-control" placeholder="Education">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Occupation</label>
											<div class="col-md-8">
												<input type="text" autocomplete="off"  name="applicant_family_occupation" id="applicant_family_occupation" value="<?php echo $result['applicant_family_occupation'];?>" class="form-control" placeholder="Occupation">
											</div>
										</div>
										<div class="form-group">
