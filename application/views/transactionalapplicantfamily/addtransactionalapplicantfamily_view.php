	...
	document.getElementById("applicant_family_remark").value = "";
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Form Add Transactional Applicant Family
					</h3>
								...
								<div class="form-body">
									...
									?>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" name="applicant_family_address" id="applicant_family_address" value="<?php echo $data['applicant_family_address'];?>" class="form-control" placeholder="address">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group input-medium date date-picker" data-date="<?php echo date("d-m-Y");?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
													<input type="text" name="applicant_family_date_of_birth" class="form-control" value="<?php echo tgltoview($data['applicant_family_date_of_birth'])?>" readonly>
