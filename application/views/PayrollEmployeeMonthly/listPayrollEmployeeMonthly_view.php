<script>
	...
	function reset_filter() {
		document.location = base_url + "PayrollEmployeeMonthly/reset_search";
	}
</script>
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url(); ?>PayrollEmployeeMonthly">
...
<?php echo form_open('PayrollEmployeeMonthly/filter', array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
					...
					<tbody>
						...
						foreach ($hroemployeedata_monthly as $key => $val) {
							...
							echo "
										<tr>			
											<td>" . $no . "</td>						
											<td>" . $this->PayrollEmployeeMonthly_model->getEmployeeName($val['employee_id']) . "</td>
											<td>" . $this->PayrollEmployeeMonthly_model->getDivisionName($val['division_id']) . "</td>
											<td>" . $this->PayrollEmployeeMonthly_model->getDepartmentName($val['department_id']) . "</td>
											<td>" . $this->PayrollEmployeeMonthly_model->getSectionName($val['section_id']) . "</td>
											<td>
												<a href='" . $this->config->item('base_url') . 'PayrollEmployeeMonthly/addPayrollEmployeeMonthly/' . $val['employee_id'] . "' class='btn default btn-xs green-jungle'>
