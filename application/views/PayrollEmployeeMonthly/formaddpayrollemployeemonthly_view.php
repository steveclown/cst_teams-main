<script>
	function reset_session(){
	 	// alert('asd');
		document.location = base_url+"payrollemployeemonthly/reset_session";
	}

	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('payrollemployeemonthly/function_elements_add');?>",
	...
	function function_state_add(value){
		...
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('payrollemployeemonthly/function_state_add');?>",
				data : {'value' : value},
				success: function(msg){
			}
		});
			...
			<div class="portlet-body display-hide form">
				<div class="form-body ">
					<div class = "row">
						...
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="division_id" id="division_id" value="<?php echo $this->payrollemployeemonthly_model->getDivisionName($hroemployeedata['division_id'])?>" class="form-control" readonly>
					...
					<div class = "row">
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="department_id" id="department_id" value="<?php echo $this->payrollemployeemonthly_model->getDepartmentName($hroemployeedata['department_id'])?>" class="form-control" readonly>
						...
						<div class = "col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="section_id" id="section_id" value="<?php echo $this->payrollemployeemonthly_model->getSectionName($hroemployeedata['section_id'])?>" class="form-control" readonly>
...
<?php 
	echo form_open('payrollemployeemonthly/processCalculatePayrollEmployeeMonthly',array('id' => 'myform', 'class' => 'horizontal-form')); 
					...
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								...
								<div class="actions">
									<a href="<?php echo base_url();?>payrollemployeemonthly" class="btn btn-default sm">
							...
							<div class="portlet-body form">
								<div class="form-body">
									...
									<div class = "row">
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  name="bank_name" id="bank_name" value="<?php echo $this->payrollemployeemonthly_model->getBankName($payrollemployeepayment['bank_id'])?>" class="form-control" onChange="function_elements_add(this.name, this.value);" readonly>
									...
									<div class = "row">
										...
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  name="employee_monthly_incentive_amount" id="employee_monthly_incentive_amount" value="<?php echo $payrollemployeemonthly['employee_monthly_incentive_amount']?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
									...
									<div class = "row">
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  name="employee_monthly_loan_amount" id="employee_monthly_loan_amount" value="<?php echo $payrollemployeemonthly['employee_monthly_loan_amount']?>" class="form-control" onChange="function_elements_add(this.name, this.value);">
										...
										<div class = "col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  name="employee_monthly_salary_total_view" id="employee_monthly_salary_total_view" value="<?php echo nominal($payrollemployeemonthly['employee_monthly_salary_total'])?>" class="form-control" onChange="function_elements_add(this.name, this.value);" readonly>
												<input type="hidden" name="employee_monthly_salary_total" id="employee_monthly_salary_total" value="<?php echo $payrollemployeemonthly['employee_monthly_salary_total']?>" class="form-control" onChange="function_elements_add(this.name, this.value);" readonly>
						...
						<div class="col-md-6">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-advance table-hover">
									...
									<tbody>
									<?php
										$data_payrollemployeemonthlyallowance = $this->session->userdata('addarrayemployeeallowance-'.$sesi['unique']);
										...
										if(!is_array($data_payrollemployeemonthlyallowance)){
											...
											foreach ($data_payrollemployeemonthlyallowance as $keyMonthlyAllowance=>$valMonthlyAllowance){
												echo"
													<tr>
														<td>".$this->payrollemployeemonthly_model->getAllowanceName($valMonthlyAllowance['allowance_id'])."</td>
									...
									<?php
										...
										if(!is_array($data_payrollemployeemonthlydeduction)){
											...
											foreach ($data_payrollemployeemonthlydeduction as $keyMonthlyDeduction=>$valMonthlyDeduction){
												echo"
													<tr>
														<td>".$this->payrollemployeemonthly_model->getDeductionName($valMonthlyDeduction['deduction_id'])."</td>
						...
						<div class="col-md-6">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-advance table-hover">
									...
									<tbody>
									<?php
										$data_payrollemployeemonthlyovertime = $this->session->userdata('addarrayemployeeovertime-'.$sesi['unique']);
...
*/
										...
										if(!is_array($data_payrollemployeemonthlyhomeearly)){
											...
											foreach ($data_payrollemployeemonthlyhomeearly as $keyHomeEarly=>$valHomeEarly){
												echo"
													<tr>
														<td>".$this->payrollemployeemonthly_model->getDeductionName($valHomeEarly['deduction_id'])."</td>
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body display-hide form">
				<div class="form-body ">
						...
						<div class="col-md-6">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-advance table-hover">
									...
									<tbody>
									<?php
										$data_payrollemployeemonthlyleaverequest = $this->session->userdata('addarrayemployeeleaverequest-'.$sesi['unique']);
										...
										if(!is_array($data_payrollemployeemonthlyleaverequest)){
											...
											foreach ($data_payrollemployeemonthlyleaverequest as $keyLeave=>$valLeave){
												echo"
													<tr>
														<td>".$this->payrollemployeemonthly_model->getAnnualLeaveName($valLeave['annual_leave_id'])."</td>
						...
						<div class="col-md-6">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-advance table-hover">
									...
									<tbody>
									<?php
										$data_payrollemployeemonthlydayoff = $this->session->userdata('addarrayemployeedayoff-'.$sesi['unique']);
										...
										if(!is_array($data_payrollemployeemonthlydayoff)){
											...
											foreach ($data_payrollemployeemonthlydayoff as $keyDayOff=>$valDayOff){
												echo"
													<tr>
														<td>".$this->payrollemployeemonthly_model->getDayOffName($valDayOff['dayoff_id'])."</td>
						...
						<div class="col-md-6">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-advance table-hover">
									...
									<tbody>
									<?php
										$data_payrollemployeemonthlyovertimerequest = $this->session->userdata('addarrayemployeeovertimerequest-'.$sesi['unique']);
										...
										if(!is_array($data_payrollemployeemonthlyovertimerequest)){
											...
											foreach ($data_payrollemployeemonthlyovertimerequest as $keyOvertime=>$valOvertime){
												echo"
													<tr>
														<td>".$this->payrollemployeemonthly_model->getOvertimeTypeName($valOvertime['overtime_type_id'])."</td>
						...
						<div class="col-md-6">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-advance table-hover">
									...
									<tbody>
									<?php
										$data_payrollemployeemonthlyhomeearlymonthly = $this->session->userdata('addarrayemployeehomeearlymonthly-'.$sesi['unique']);
										...
										if(!is_array($data_payrollemployeemonthlyhomeearlymonthly)){
											...
											foreach ($data_payrollemployeemonthlyhomeearlymonthly as $keyHomeEarlyMonthly=>$valHomeEarlyMonthly){
												echo"													
													<tr>
														<td>".$this->payrollemployeemonthly_model->getHomeEarlyName($valHomeEarlyMonthly['home_early_id'])."</td>
						...
						<div class="col-md-12">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-advance table-hover">
									...
									<tbody>
									<?php
										$data_payrollemployeemonthlypermit = $this->session->userdata('addarrayemployeepermit-'.$sesi['unique']);
										...
										if(!is_array($data_payrollemployeemonthlypermit)){
											...
											foreach ($data_payrollemployeemonthlypermit as $keyPermit=>$valPermit){
												echo"
													<tr>
														<td>".$this->payrollemployeemonthly_model->getPermitName($valPermit['permit_id'])."</td>
						...
						<div class="col-md-6">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-advance table-hover">
									...
									<tbody>
									<?php
										$data_payrollemployeemonthlyabsence = $this->session->userdata('addarrayemployeeabsence-'.$sesi['unique']);
										...
										if(!is_array($data_payrollemployeemonthlyabsence)){
											...
											foreach ($data_payrollemployeemonthlyabsence as $keyAbsence=>$valAbsence){
												echo"
													<tr>
														<td>".$this->payrollemployeemonthly_model->getAbsenceName($valAbsence['absence_id'])."</td>
						...
						<div class="col-md-6">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-advance table-hover">
									...
									<tbody>
									<?php
										$data_payrollemployeemonthlylate = $this->session->userdata('addarrayemployeelate-'.$sesi['unique']);
										...
										if(!is_array($data_payrollemployeemonthlylate)){
											...
											foreach ($data_payrollemployeemonthlylate as $keyLate=>$valLate){
												echo"
													<tr>
														<td>".$this->payrollemployeemonthly_model->getLateName($valLate['late_id'])."</td>
					...
					<?php 
						echo form_open('payrollemployeemonthly/processAddPayrollEmployeeMonthly',array('id' => 'myform', 'class' => 'horizontal-form')); 
						$data = $this->session->userdata('addhroemployeeallowance');
					?>
					...
					<input type="hidden" name="employee_monthly_loan_amount" value="<?php echo $payrollemployeemonthly['employee_monthly_loan_amount']; ?>"/>
					...
					<input type="hidden" name="employee_monthly_salary_total" value="<?php echo $payrollemployeemonthly['employee_monthly_salary_total']; ?>"/>
