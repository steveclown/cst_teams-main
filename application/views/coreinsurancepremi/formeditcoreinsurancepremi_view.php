							...
							<div class="portlet-body form">
								<div class="form-body">
									...
									<div class = "row">
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="insurance_premi_code" id="insurance_premi_code" value="<?php echo $coreinsurancepremi['insurance_premi_code']?>" class="form-control" >
										...
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" name="insurance_premi_amount" id="insurance_premi_amount" value="<?php echo $coreinsurancepremi['insurance_premi_amount']?>" class="form-control" >
												<span class="help-block">
