								...
								<div class="form-body">
									...
									?>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<div class="input-group input-medium date date-picker" data-date="<?php echo date("d-m-Y");?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
													<input type="text" autocomplete="off"  name="leave_adjustment_date" id="leave_adjustment_date" value="<?php echo tgltoview($result['leave_adjustment_date'])?>" class="form-control" placeholder="Date" readonly>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" autocomplete="off"  name="leave_adjustment_annual_days" id="leave_adjustment_annual_days" value="<?php echo $result['leave_adjustment_annual_days']?>" class="form-control" placeholder="Annual Days">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Extra Days</label>
											<div class="col-md-3">
												<input type="text" autocomplete="off"  name="leave_adjustment_extra_days" id="leave_adjustment_extra_days" value="<?php echo $result['leave_adjustment_extra_days']?>" class="form-control" placeholder="Extra Days">
											</div>
										</div>
										<div class="form-group">
