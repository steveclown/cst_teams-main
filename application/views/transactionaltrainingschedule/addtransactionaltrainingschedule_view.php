								...
								<div class="form-body">
									...
									?>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" name="training_schedule_name" id="training_schedule_name" onChange="warningname(training_schedule_name);" value="<?php echo $data['training_schedule_name'];?>" class="form-control" placeholder="Schedule Name">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" name="training_schedule_capacity" id="training_schedule_capacity" onChange="warningcapacity(this.value);" value="<?php echo $data['training_schedule_capacity'];?>" class="form-control" placeholder="Schedule Capacity">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" name="training_schedule_duration" id="training_schedule_duration" onChange="warningduration(this.value);" value="<?php echo $data['training_schedule_duration'];?>" class="form-control" placeholder="Schedule Duration">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" name="training_schedule_location" id="training_schedule_location" onChange="warninglocation(training_schedule_location);" value="<?php echo $data['training_schedule_location'];?>" class="form-control" placeholder="Schedule Location">
											</div>
										</div>
