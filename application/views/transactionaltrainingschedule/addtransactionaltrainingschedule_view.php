...
<script>
function ulang(){
	document.getElementById("training_job_title_id").value = "";
	document.getElementById("training_title_id").value = "";
	document.getElementById("training_provider_id").value = "";
	document.getElementById("training_provider_item_id").value = "";
	document.getElementById("training_schedule_start_date").value = "";
	document.getElementById("training_schedule_end_date").value = "";
	...
	document.getElementById("training_schedule_remark").value = "";
}
        ...
        $("#Save").click(function(){
			...
			<div class="row">
				<div class="col-md-12">
					...
					<li>
						<a href="#">
							Add Transactional Training Schedule
						</a>
						<i class="fa fa-angle-right"></i>
					</li>
				</ul>
					...
					<div class="col-md-12">
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="form-body">
									<?php 
										echo form_open('transactionaltrainingschedule/processaddtransactionaltrainingschedule',array('id' => 'myform', 'class' => 'form-horizontal')); 
										$data = $this->session->userdata('addtransactionaltrainingschedule');
									?>
										<div class="form-group">
											<label class="control-label col-md-3">Training Job Title</label>
											<div class="col-md-3">
												<?php echo form_dropdown('training_job_title_id', $jobtitle ,set_value('training_job_title_id',$data['training_job_title_id']),'id="training_job_title_id", class="form-control select2me"');?>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<?php echo form_dropdown('training_title_id', $title ,set_value('training_title_id',$data['training_title_id']),'id="training_title_id", class="form-control select2me"');?>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<?php echo form_dropdown('training_provider_id', $provider ,set_value('training_provider_id',$data['training_provider_id']),'id="training_provider_id", class="form-control select2me"');?>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<?php echo form_dropdown('training_provider_item_id', $provideritem ,set_value('training_provider_item_id',$data['training_provider_item_id']),'id="training_provider_item_id", class="form-control select2me"');?>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" autocomplete="off"  name="training_schedule_name" id="training_schedule_name" onChange="warningname(training_schedule_name);" value="<?php echo $data['training_schedule_name'];?>" class="form-control" placeholder="Schedule Name">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" autocomplete="off"  name="training_schedule_capacity" id="training_schedule_capacity" onChange="warningcapacity(this.value);" value="<?php echo $data['training_schedule_capacity'];?>" class="form-control" placeholder="Schedule Capacity">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" autocomplete="off"  name="training_schedule_duration" id="training_schedule_duration" onChange="warningduration(this.value);" value="<?php echo $data['training_schedule_duration'];?>" class="form-control" placeholder="Schedule Duration">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" autocomplete="off"  name="training_schedule_location" id="training_schedule_location" onChange="warninglocation(training_schedule_location);" value="<?php echo $data['training_schedule_location'];?>" class="form-control" placeholder="Schedule Location">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
											<textarea rows="5" name="training_schedule_remark" id="training_schedule_remark" class="form-control" placeholder="Strength Remark"><?php echo $data['training_schedule_remark'];?></textarea>
											</div>
										</div>
								</div>
