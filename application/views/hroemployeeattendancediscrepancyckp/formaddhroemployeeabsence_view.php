...
<script>
	...
	function reset_add_absence(){
		document.location = base_url+"hroemployeeadministrationckp/reset_add_absence/<?php echo $employee_id; ?>/<?php echo $employee_attendance_date; ?>/<?php echo $employee_attendance_data_id; ?>";
	}
...
<?php 
	echo form_open('hroemployeeattendancediscrepancyckp/processAddHROEmployeeAbsence',array('id' => 'myform', 'class' => 'horizontal-form')); 
						...
						foreach ($hroemployeeabsence as $key=>$val){
							echo"
								<tr>
									...
									<td>
										<a href='".$this->config->item('base_url').'hroemployeeattendancediscrepancyckp/deleteHROEmployeeAbsence/'.$val['employee_id']."/".$val['employee_absence_id']."/".$employee_attendance_date."/".$employee_attendance_data_id."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
