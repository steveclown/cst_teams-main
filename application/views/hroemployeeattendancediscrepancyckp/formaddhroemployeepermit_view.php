...
<?php 
	echo form_open('hroemployeeattendancediscrepancyckp/processAddHROEmployeePermit',array('id' => 'myform', 'class' => 'horizontal-form')); 
						...
						foreach ($hroemployeepermit as $key=>$val){
							echo"
								<tr>
									...
									<td>
										<a href='".$this->config->item('base_url').'hroemployeeattendancediscrepancyckp/deleteHROEmployeePermit/'.$val['employee_id']."/".$val['employee_permit_id']."/".$employee_attendance_date."/".$employee_attendance_data_id."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
