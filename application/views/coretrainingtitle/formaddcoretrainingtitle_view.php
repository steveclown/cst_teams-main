...
?>
		...
		<div class = "page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="<?php echo base_url();?>coretrainingtitle/addCoreTrainingTitle">
						Add Training Title
					</a>
					<i class="fa fa-angle-right"></i>
				</li>
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				<div class="form-body">
					<?php 
						echo form_open('coretrainingtitle/processAddCoreTrainingTitle',array('id' => 'myform', 'class' => 'horizontal-form')); 
						$data = $this->session->userdata('addcoretrainingtitle');
					?>
					<div class = "row">
						<div class="col-md-6">							
							<div class="form-group form-md-line-input">
								<?php echo form_dropdown('training_category_id', $coretrainingcategory, $data['training_category_id'], 'id ="training_category_id", class="form-control select2me" onChange="function_elements_add(this.name, this.value);"');?>
					...
					<div class = "row">
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="training_title_code" id="training_title_code" class="form-control" value="<?php echo $data['training_title_code']?>" onChange="function_elements_add(this.name, this.value);" >
						...
						<div class="col-md-6">
							<div class="form-group form-md-line-input">
								<input type="text" autocomplete="off"  name="training_title_name" id="training_title_name" class="form-control" value="<?php echo $data['training_title_name']?>"  onChange="function_elements_add(this.name, this.value);">
					...
					<div class = "row">
						<div class="col-md-12">
							<div class="form-group form-md-line-input">
								<textarea class="form-control" rows="3", name="training_title_remark", id="training_title_remark", value="<?php echo $data['training_title_remark'];?>" onChange="function_elements_add(this.name, this.value);"></textarea>
