										...
										<div class="col-md-6">
											<div class="form-group">
												...
												*
												...
												<input type="text" name="loan_type_code" id="loan_type_code" value="<?php echo $data['loan_type_code'];?>" class="form-control" placeholder="Loan Type Code">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												*
												...
												<input type="text" name="loan_type_name" id="loan_type_name" value="<?php echo $data['loan_type_name'];?>" class="form-control" placeholder="Loan Type Name">
											</div>
										</div>
									</div>
								</div>
