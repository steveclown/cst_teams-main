...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off" class="form-control" id="period_home_early_hour_start" name="period_home_early_hour_start" onChange="function_elements_add_home_early(this.name, this.value);" value="<?php echo $data['period_home_early_hour_start']; ?>">
	...
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off" class="form-control" id="period_home_early_hour_end" name="period_home_early_hour_end" onChange="function_elements_add_home_early(this.name, this.value);" value="<?php echo $data['period_home_early_hour_end']; ?>">
