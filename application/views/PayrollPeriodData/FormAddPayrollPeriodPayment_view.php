...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off" class="form-control" id="period_payment_working_start" name="period_payment_working_start" onChange="function_elements_add_payment(this.name, this.value);" value="<?php echo $data['period_payment_working_start']; ?>">
	...
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off" class="form-control" id="period_payment_working_end" name="period_payment_working_end" onChange="function_elements_add_payment(this.name, this.value);" value="<?php echo $data['period_payment_working_end']; ?>">
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off" class="form-control" id="basic_salary_monthly" name="basic_salary_monthly" onChange="function_elements_add_payment(this.name, this.value);" value="<?php echo $data['basic_salary_monthly']; ?>">
	...
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off" class="form-control" id="basic_salary_daily" name="basic_salary_daily" onChange="function_elements_add_payment(this.name, this.value);" value="<?php echo $data['basic_salary_daily']; ?>">
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off" class="form-control" id="meal_subvention_monthly" name="meal_subvention_monthly" onChange="function_elements_add_payment(this.name, this.value);" value="<?php echo $data['meal_subvention_monthly']; ?>">
	...
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off" class="form-control" id="meal_subvention_daily" name="meal_subvention_daily" onChange="function_elements_add_payment(this.name, this.value);" value="<?php echo $data['meal_subvention_daily']; ?>">
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off" class="form-control" id="basic_overtime" name="basic_overtime" onChange="function_elements_add_payment(this.name, this.value);" value="<?php echo $data['basic_overtime']; ?>">
