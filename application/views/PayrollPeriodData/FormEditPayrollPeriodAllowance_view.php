...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  class="form-control" id="period_allowance_working_start" name="period_allowance_working_start" onChange="function_elements_edit_allowance(this.name, this.value);" value="<?php echo $data['period_allowance_working_start'];?>">
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  class="form-control" id="period_allowance_working_end" name="period_allowance_working_end" onChange="function_elements_edit_allowance(this.name, this.value);" value="<?php echo $data['period_allowance_working_end'];?>">
...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  name="period_allowance_amount_monthly" id="period_allowance_amount_monthly" value="<?php echo $data['period_allowance_amount_monthly']?>" class="form-control" onChange="function_elements_edit_allowance(this.name, this.value);">
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  name="period_allowance_amount_daily" id="period_allowance_amount_daily" value="<?php echo $data['period_allowance_amount_daily']?>" class="form-control" onChange="function_elements_edit_allowance(this.name, this.value);">
...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  name="period_allowance_description" id="period_allowance_description" value="<?php echo $data['period_allowance_description']?>" class="form-control" onChange="function_elements_edit_allowance(this.name, this.value);">
