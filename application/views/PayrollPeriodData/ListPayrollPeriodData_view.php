	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url(); ?>payroll-period-data/add" class="btn btn-default btn-sm">
						...
						foreach ($payrollperiod as $key => $val) {
							echo "
										<tr>			
											...
											<td>
												<a href='" . $this->config->item('base_url') . 'payroll-period-data/edit/' . $val['payroll_period_id'] . "' class='btn default btn-xs purple'>
													<i class='fa fa-edit'></i> Edit
												</a>

												<a href='" . $this->config->item('base_url') . 'payroll-period-data/detail/' . $val['payroll_period_id'] . "' class='btn default btn-xs yellow-lemon'>
