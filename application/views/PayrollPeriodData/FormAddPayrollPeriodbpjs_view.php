...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  class="form-control" id="period_bpjs_working_start" name="period_bpjs_working_start" onChange="function_elements_add_bpjs(this.name, this.value);" value="<?php echo $data['period_bpjs_working_start'];?>">
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  class="form-control" id="period_bpjs_working_end" name="period_bpjs_working_end" onChange="function_elements_add_bpjs(this.name, this.value);" value="<?php echo $data['period_bpjs_working_end'];?>">
...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  name="period_bpjs_kesehatan_amount" id="period_bpjs_kesehatan_amount" value="<?php echo $data['period_bpjs_kesehatan_amount']?>" class="form-control" onChange="function_elements_add_bpjs(this.name, this.value);">
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  name="period_bpjs_tenagakerja_amount" id="period_bpjs_tenagakerja_amount" value="<?php echo $data['period_bpjs_tenagakerja_amount']?>" class="form-control" onChange="function_elements_add_bpjs(this.name, this.value);">
...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  name="bpjs_tenagakerja_subvention_monthly" id="bpjs_tenagakerja_subvention_monthly" value="<?php echo $data['bpjs_tenagakerja_subvention_monthly']?>" class="form-control" onChange="function_elements_add_bpjs(this.name, this.value);">
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" autocomplete="off"  name="bpjs_tenagakerja_subvention_daily" id="bpjs_tenagakerja_subvention_daily" value="<?php echo $data['bpjs_tenagakerja_subvention_daily']?>" class="form-control" onChange="function_elements_add_bpjs(this.name, this.value);">
