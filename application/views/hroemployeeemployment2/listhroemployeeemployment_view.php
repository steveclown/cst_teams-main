							...
							<?php
								...
								foreach ($hroemployeedata_employment as $key=>$val){
									...
									echo"
										<tr>			
											<td>".$no."</td>						
											<td>".$this->hroemployeeemployment_model->getEmployeeName($val['employee_id'])."</td>
											<td>".$this->hroemployeeemployment_model->getDivisionName($val['division_id'])."</td>
