...
<script>
    ...
    function reset_filter(){
		document.location = base_url+"hroemployeeemployment/reset_search";
	}
	...
	$(document).ready(function(){
        $("#division_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>hroemployeeemployment/getCoreDepartment",
    ...
    $(document).ready(function(){
        $("#department_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>hroemployeeemployment/getCoreSection",
    ...
    $(document).ready(function(){
        $("#section_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>hroemployeeemployment/getHROEmployeeData",
							...
							<div class="form-group form-md-line-input">
								<?php
									if (!empty($data['division_id'])){
										$coredepartment = create_double($this->hroemployeeemployment_model->getCoreDepartment($data['division_id']),'department_id','department_name');
							...
							<div class="form-group form-md-line-input">
								<?php
									if (!empty($data['department_id'])){
										$coresection = create_double($this->hroemployeeemployment_model->getCoreSection($data['department_id']),'section_id','section_name');
							...
							<div class="form-group form-md-line-input">
								<?php
									if (!empty($data['section_id'])){
										$hroemployeedata = create_double($this->hroemployeeemployment_model->getHROEmployeeData($data['division_id'], $data['department_id'], $data['section_id']),'employee_id','employee_name');
