...
<?php 
	echo form_open('transactionalleaverequest/processEdittransactionalleaverequest',array('id' => 'myform', 'class' => 'form-horizontal')); 
...
?>
			<div class="row">
				<div class="col-md-12">
					...
					<li class="btn-group">
						<div class="actions">
							<a href="<?php echo base_url();?>transactionalleaverequest" class="btn green yellow-stripe">
					...
					<li>
						<a href="<?php echo base_url();?>transactionalleaverequest">
							Leave Request List
						</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<?php echo base_url();?>transactionalleaverequest/edit/<?php echo $result['leave_request_id'];?>">
							Edit Leave Request
						</a>
						<i class="fa fa-angle-right"></i>
					</li>
								...
								<div class="form-body">
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<div class="input-group input-medium date date-picker" data-date="<?php echo date("Y-m-d");?>" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
													<input type="text" autocomplete="off"  name="leave_request_start_date" id="leave_request_start_date" value="<?php echo $result['leave_request_start_date']?>" class="form-control" placeholder="Start Date" readonly>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<div class="input-group input-medium date date-picker" data-date="<?php echo date("Y-m-d");?>" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
													<input type="text" autocomplete="off"  name="leave_request_end_date" id="leave_request_end_date" value="<?php echo $result['leave_request_end_date']?>" class="form-control" placeholder="End Date" readonly>
													<span class="input-group-btn">
														<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
													</span>
												</div>
