...
?>
			...
			<h1 class="page-title">
				Employee Commission List <small>Manage Employee Commission</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php 
	$data = $this->session->userdata('filter-payrollemployeecommission',$data);
	echo form_open('payrollemployeecommission/filter',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
							...
							<div class="form-group form-md-line-input">
								<?php
									if (!empty($data['division_id'])){
										$coredepartment = create_double($this->payrollemployeecommission_model->getCoreDepartment($data['division_id']), 'department_id', 'department_name');
							...
							<div class="form-group form-md-line-input">
								<?php
									if (!empty($data['department_id'])){
										$coresection = create_double($this->payrollemployeecommission_model->getCoreSection($data['department_id']), 'section_id', 'section_name');
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
						...
						<tbody>
							<?php
								$no=1;
								foreach ($hroemployeedata_commission as $key=>$val){
									...
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'payrollemployeecommission/addPayrollEmployeeCommission/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
