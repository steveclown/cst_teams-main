								...
								<div class="form-body">
									...
									?>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" name="hospital_adjustment_amount" id="hospital_adjustment_amount" value="<?php echo $data['hospital_adjustment_amount'];?>" class="form-control" placeholder="Amount">
