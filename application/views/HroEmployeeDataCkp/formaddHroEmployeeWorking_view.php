<?php 
	...
	if (empty($data['employee_last_day_off'])) {
		$data['employee_last_day_off']="";
	}
	if (empty($data['employee_residential_city'])) {
		$data['employee_residential_city']="";
	}
	if (empty($data['employee_day_off_cycle'])) {
		$data['employee_day_off_cycle']="";
	}
	if (empty($data['employee_day_off_status'])) {
		$data['employee_day_off_status']="";
	}
