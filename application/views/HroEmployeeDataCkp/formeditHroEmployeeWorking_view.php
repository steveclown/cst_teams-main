<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" name="employee_rfid_code" id="employee_rfid_code" value="<?php echo $HroEmployeeDataCkp['employee_rfid_code'];?>" class="form-control" onChange="function_elements_edit(this.name, this.value);" readonly>
...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" name="employee_day_off_cycle" id="employee_day_off_cycle" value="<?php echo $HroEmployeeDataCkp['employee_day_off_cycle'];?>" class="form-control" onChange="function_elements_edit(this.name, this.value);" readonly>
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" name="employee_day_off_status" id="employee_day_off_status" value="<?php echo $dayoffstatus[$HroEmployeeDataCkp['employee_day_off_status']];?>" class="form-control" onChange="function_elements_edit(this.name, this.value);" readonly>
...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" name="employee_employment_working_status" id="employee_employment_working_status" value="<?php echo $HroEmployeeDataCkp['employee_employment_working_status'];?>" class="form-control" onChange="function_elements_edit(this.name, this.value);" readonly>
	...
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" name="employee_employment_overtime_status" id="employee_employment_overtime_status" value="<?php echo $overtimestatus[$HroEmployeeDataCkp['employee_employment_overtime_status']];?>" class="form-control" onChange="function_elements_edit(this.name, this.value);" readonly>
...
<div class = "row">
	<div class = "col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" name="employee_employment_status" id="employee_employment_status" value="<?php echo $employeestatus[$HroEmployeeDataCkp['employee_employment_status']];?>" class="form-control" onChange="function_elements_edit(this.name, this.value);" readonly>
