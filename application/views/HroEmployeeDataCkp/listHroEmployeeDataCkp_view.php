...
<script>
	...
	$(document).ready(function(){
        $("#division_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>HroEmployeeDataCkp/lookup_core_division",
    ...
    function reset_filter(){
		document.location = base_url+"HroEmployeeDataCkp/reset_search";
	}
</script>
...
<?php
	$data=$this->session->userdata('filter-HroEmployeeDataCkp');
?>
<?php echo form_open('HroEmployeeDataCkp/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="actions">
								<a href="<?php echo base_url();?>HroEmployeeDataCkp/addHROEmployeeData" class="btn btn-default sm">
							...
							<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
								...
								<tbody>
									<?php
										...
										print_r($HroEmployeeDataCkp);
										*/
										foreach ($HroEmployeeDataCkp as $key=>$val){
											echo"
												<tr>				
													<td>".$no."</td>					
													...
													<td>".$val['unit_name']."</td>
													<td>
														<a href='".$this->config->item('base_url').'HroEmployeeDataCkp/editHROEmployeeData/'.$val['employee_id']."' class='btn default btn-xs purple'>
															<i class='fa fa-edit'></i> Edit
														</a>

														<a href='".$this->config->item('base_url').'HroEmployeeDataCkp/deleteHROEmployeeData/'.$val['employee_id']."' class='btn default btn-xs red'>
															<i class='fa fa-delete'></i> Hapus
														</a>
													</td>
												</tr>
											";
