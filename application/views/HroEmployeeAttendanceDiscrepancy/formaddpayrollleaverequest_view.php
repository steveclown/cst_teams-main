...
<?php 
	echo form_open('hroemployeeattendancediscrepancy/processAddPayrollLeaveRequest',array('id' => 'myform', 'class' => 'horizontal-form')); 
						...
						foreach ($payrollleaverequest as $key=>$val){
							...
							echo"
								<tr>
									...
									<td>
										<a href='".$this->config->item('base_url').'hroemployeeattendancediscrepancy/deletePayrollLeaveRequest/'.$val['employee_id']."/".$val['leave_request_id']."/".$employee_attendance_date."/".$employee_attendance_data_id."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
