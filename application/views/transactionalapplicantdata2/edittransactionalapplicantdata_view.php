										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group input-medium date date-picker" data-date="<?php echo date("d-m-Y");?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
													<input type="text" autocomplete="off"  name="applicant_application_date" class="form-control" value="<?php echo tgltoview($result['applicant_application_date'])?>" readonly>
