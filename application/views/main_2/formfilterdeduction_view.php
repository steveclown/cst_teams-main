<?php	
	$sesi = $this->session->userdata('filter-deduction');
	if(!is_array($sesi)){
		$sesi['deduction_id']	='';
		$sesi['start_period']		='';
		$sesi['end_period']			='';
...
?>
<?php echo form_open("main/filterdeduction", array('class' => 'horizontal-form')); ?>
<button class="btn btn-success" type="button" id='btn-change' onClick="openform6()">Advanced Search</button>
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				...
				<?php echo form_dropdown('deduction_id', $deduction ,set_value('deduction_id',$data['deduction_id']),'id="deduction_id", class="form-control select2me"');?>
			</div>
		</div>
	</div>		
	<div class="row">
