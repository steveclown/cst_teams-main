									...
									<div class = "row">
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  name="probation_code" id="probation_code" value="<?php echo $data['probation_code'];?>" class="form-control">
										...
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  name="probation_name" id="probation_name" value="<?php echo $data['probation_name'];?>" class="form-control" >
