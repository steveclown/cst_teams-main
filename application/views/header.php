...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>TEAMS Talent Management System</title>
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <?php 
								...
								$scheduleemployeeshiftlast = $this->MainPage_model->getScheduleEmployeeShiftLast($start_from);
							?>
							<li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
							
							<?php 
							/*	// print_r($data_expired);exit;
								if($scheduleemployeeshiftlast){
									echo"
										<a href='#' class='dropdown-toggle' data-toggle='dropdown' data-hover='dropdown' data-close-others='true'>
											<i class='icon-calendar'></i>
											<span class='badge badge-default'>
												".$scheduleemployeeshiftlast->num_rows()."
											</span>
										</a>
										<ul class='dropdown-menu'>
		                                    <li class='external'>
		                                        <h3>You have
		                                            <span class='bold'>".$scheduleemployeeshiftlast->num_rows()." </span> Schedule Expired </h3>
		                                        <a href='".base_url()."ScheduleEmployeeSchedule/lastScheduleEmployeeSchedule'>view all</a>
		                                    </li>
		                                    <li>
		                                        <ul class='dropdown-menu-list scroller' style='height: 275px;' data-handle-color='#637283'>";
		                                        	foreach($scheduleemployeeshiftlast->result_array() as $key=>$val){
			                                            echo "<li>
			                                                <a href='#'>
			                                                    <span class='subject'>
			                                                        <span class='from'>".$val['employee_shift_code']." </span>
			                                                        <span class='time'>".tgltoview($val['employee_shift_last_schedule_date'])."</span>
			                                                    </span>
			                                                    <span class='message'>".$val['location_name']."</span>
			                                                </a>
			                                            </li>";
		                                        	}
		                                        echo "</ul>
							...
							*/
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <ul class="dropdown-menu dropdown-menu-default">
                                    <li>
                                        <a href="<?php echo base_url();?>systemuser/userprofile">
                                            <i class="icon-user"></i> My Profile </a>
                                    </li>
                                    <li class="divider"> </li>
                                    <!-- <li>
                                        <a href="<?php echo base_url();?>validationprocess/pageuserlock">
