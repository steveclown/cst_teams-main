<script>
    ...
    function reset_filter(){
		document.location = base_url+"HroEmployeeTransferCkp/reset_search";
	}
</script>
...
?>
			...
			<h1 class="page-title">
				Daftar Transfer Karyawan <small>Kelola Transfer Karyawan</small>
			</h1>
			<!-- END PAGE TITLE & BREADCRUMB-->

<?php echo form_open('HroEmployeeTransferCkp/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
						...
						<tbody>
							<?php
								$no=1;
								foreach ($hroemployeedata_transfer as $key=>$val){
									/*<a href='".$this->config->item('base_url').'HroEmployeeTransferCkp/editHROEmployeeTransfer/'.$val['employee_id']."' class='btn default btn-xs purple'>
													<i class='fa fa-edit'></i> Edit
												</a>*/
									echo"
										<tr>			
											<td>".$no."</td>						
											<td>".$this->HroEmployeeTransferCkp_model->getEmployeeName($val['employee_id'])."</td>
											...
											<td>
												<a href='".$this->config->item('base_url').'HroEmployeeTransferCkp/addHROEmployeeTransfer/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
