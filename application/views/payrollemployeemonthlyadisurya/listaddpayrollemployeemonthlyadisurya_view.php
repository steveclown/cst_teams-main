...
<?php
		$this->load->view('payrollemployeemonthlyadisurya/formaddpayrollemployeemonthlyadisurya_view');
						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-bordered table-advance table-hover">
									...
									<tbody>
									<?php
										if(!is_array($payrollemployeemonthlyadisurya_data)){
											echo "<tr><th colspan='8' style='text-align  : center !important;'>Data is Empty</th></tr>";
										} else {
											foreach ($payrollemployeemonthlyadisurya_data as $key=>$val){
												echo"
													<tr>
														...
														<td>
															<a href='".$this->config->item('base_url').'payrollemployeemonthlyadisurya/deletePayrollEmployeeMonthly_Data/'.$val['employee_id']."/".$val['employee_monthly_id']."' onClick='javascript:return confirm(\"Are you sure you want to delete this entry ?\")' class='btn default btn-xs red'>
																<i class='fa fa-trash-o'></i> Delete
															</a>

															<a href='".$this->config->item('base_url').'payrollemployeemonthlyadisurya/detailPayrollEmployeeMonthly_Data/'.$val['employee_monthly_id']."'class='btn default btn-xs yellow'>
