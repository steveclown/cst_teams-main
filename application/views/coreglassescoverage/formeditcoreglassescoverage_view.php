							...
							<div class="portlet-body form">
								<div class="form-body">
									...
									<div class = "row">
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  name="glasses_coverage_code" id="glasses_coverage_code" value="<?php echo $coreglassescoverage['glasses_coverage_code']?>" class="form-control">
										...
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  name="glasses_coverage_name" id="glasses_coverage_name" value="<?php echo $coreglassescoverage['glasses_coverage_name']?>" class="form-control">
									...
									<div class = "row">
										...
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  name="glasses_coverage_ratio" id="glasses_coverage_ratio" value="<?php echo $coreglassescoverage['glasses_coverage_ratio']?>" class="form-control" placeholder="Glasses Coverage Ratio">
												<span class="help-block">
									...
									<div class = "row">
										<div class="col-md-6">
											<div class="form-group form-md-line-input">
												<input type="text" autocomplete="off"  name="glasses_coverage_amount" id="glasses_coverage_amount" value="<?php echo $coreglassescoverage['glasses_coverage_amount']?>" class="form-control" >
												<span class="help-block">
													 Please input only numbers.
												</span>
