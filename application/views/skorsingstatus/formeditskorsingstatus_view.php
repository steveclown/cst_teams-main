						...
						<div class = "row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" autocomplete="off"  name="skorsing_status_code" id="skorsing_status_code" class="form-control" value="<?php echo $result['skorsing_status_code']?>" placeholder="Skorsing Status Code">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" autocomplete="off"  name="skorsing_status_name" id="skorsing_status_name" class="form-control" value="<?php echo $result['skorsing_status_name']?>" placeholder="Skorsing Status Name">
								</div>
							</div>
						</div>
					</div>
