...
<script>
	...
	$(document).ready(function(){
        $("#division_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>payrollemployeemonthlyilufa/getCoreDepartment",
    ...
    $(document).ready(function(){
        $("#department_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>payrollemployeemonthlyilufa/getCoreSection",
...
<?php 
	...
	echo form_open('payrollemployeemonthlyilufa/filter',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
							...
							<div class="form-group form-md-line-input">
								<?php
									if (!empty($data['division_id'])){
										$coredepartment = create_double($this->payrollemployeemonthlyilufa_model->getCoreDepartment($data['division_id']), 'department_id', 'department_name');
							...
							<div class="form-group form-md-line-input">
								<?php
									if (!empty($data['department_id'])){
										$coresection = create_double($this->payrollemployeemonthlyilufa_model->getCoreSection($data['department_id']), 'section_id', 'section_name');
								...
								foreach ($hroemployeedata_monthly as $key=>$val){
									...
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'payrollemployeemonthlyilufa/addPayrollEmployeeMonthly/'.$val['employee_id']."' class='btn default btn-xs green-jungle'>
