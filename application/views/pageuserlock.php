...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>TEAMS Talent Management System | User Lock Screen</title>
        ...
        <div class="page-lock">
            ...
            <div class="page-body">
                ...
                <div class="lock-body">
                    ...
                    <form action="<?php echo base_url();?>validationprocess/lockvalidate" class="lock-form pull-left" method="post">
                ...
                <div class="lock-bottom">
                    <a href="<?php echo base_url() ?>validationprocess/logout">Not <?php echo $auth['username']?>?</a>
                </div>
            </div>

            <div class="page-footer-custom"> Copyright &copy; <a href = "http://www.ricemillstudio.com">RiceMill Studio 2017</a>. <br>Powered by Metronic Admin Template</div>
        </div>
        <!--[if lt IE 9]>
