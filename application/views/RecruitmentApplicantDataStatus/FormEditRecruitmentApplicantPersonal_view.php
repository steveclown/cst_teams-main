...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_name" name="applicant_name" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_name'];?>">
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_place_of_birth" name="applicant_place_of_birth" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_place_of_birth'];?>">
...
<div class="row">
	<div class="col-md-12">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_last_education" name="applicant_last_education" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_last_education'];?>">
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_city" name="applicant_city" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_city'];?>">
	...
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_postal_code" name="applicant_postal_code" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_postal_code'];?>">
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_rt" name="applicant_rt" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_rt'];?>" >
	...
	<div class="col-md-6">
		<div class="form-group form-md-line-input ">
			<input type="text" class="form-control" id="applicant_rw" name="applicant_rw" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_rw'];?>" >
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input ">
			<input type="text" class="form-control" id="applicant_kelurahan" name="applicant_kelurahan" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_kelurahan'];?>">
			<label for="form-control">Kelurahan</label>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_kecamatan" name="applicant_kecamatan" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_kecamatan'];?>" >
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_home_phone" name="applicant_home_phone" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_home_phone'];?>" >
			<label for="form-control"> Telp Rumah</label>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_mobile_phone" name="applicant_mobile_phone" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_mobile_phone'];?>" >
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_email_address" name="applicant_email_address" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_email_address'];?>">
...
<div class="row">	
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_residence_city" name="applicant_residence_city" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_residence_city'];?>">
			<label for="form-control">Kota Tempat Tinggal</label>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_residence_postal_code" name="applicant_residence_postal_code" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_residence_postal_code'];?>">
...
<div class="row">	
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_residence_rt" name="applicant_residence_rt" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_residence_rt'];?>">
			<label for="form-control">RT Tempat Tinggal</label>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_residence_rw" name="applicant_residence_rw" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_residence_rw'];?>">
...
<div class="row">	
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_residence_kelurahan" name="applicant_residence_kelurahan" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_residence_kelurahan'];?>">
			<label for="form-control">Kelurahan Tempat Tinggal</label>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_residence_kecamatan" name="applicant_residence_kecamatan" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_residence_kecamatan'];?>">
...
<div class="row">	
	...
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_heir_name" name="applicant_heir_name" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_heir_name'];?>">
...
<div class = "row">	
	...
	<div class="col-md-6">
		<div class="form-group form-md-line-input">
			<input type="text" class="form-control" id="applicant_id_number" name="applicant_id_number" onChange="function_elements_edit(this.name, this.value);" value="<?php echo $RecruitmentApplicantData['applicant_id_number'];?>" >
