...
/* PayrollPeriodData */
$route['payroll-period-data']                                    = 'PayrollPeriodData';
$route['payroll-period-data/add']                                 = 'PayrollPeriodData/addPayrollPeriodData';
$route['payroll-period-data/elements-add']                         = 'PayrollPeriodData/function_elements_add';
$route['payroll-period-data/reset-add']                         = 'PayrollPeriodData/reset_add';
$route['payroll-period-data/process-add']                         = 'PayrollPeriodData/processAddPayrollPeriodData';
$route['payroll-period-data/edit/(:num)']                        = 'PayrollPeriodData/editPayrollPeriodData/$1';
$route['payroll-period-data/delete/(:num)']                        = 'PayrollPeriodData/deletePayrollPeriodData/$1';
$route['payroll-period-data/process-edit']                      = 'PayrollPeriodData/processEditPayrollPeriodData';
$route['payroll-period-data/reset-edit/(:num)']                 = 'PayrollPeriodData/reset_edit/$1';
$route['payroll-period-data/detail/(:num)']                 = 'PayrollPeriodData/showdetail/$1';

/*=========================================  Calculation  ======================================== */

/* PayrollMonthlyPeriod */
$route['payroll-monthly-period']                                    = 'PayrollMonthlyPeriod';
$route['payroll-monthly-period/add']                         = 'PayrollMonthlyPeriod/addPayrollMonthlyPeriod';
$route['payroll-monthly-period/elements-add']                     = 'PayrollMonthlyPeriod/function_elements_add';
$route['payroll-monthly-period/reset-add']                         = 'PayrollMonthlyPeriod/reset_add';
$route['payroll-monthly-period/process-add']                     = 'PayrollMonthlyPeriod/processAddPayrollMonthlyPeriod';
$route['payroll-monthly-period/edit/(:num)']                        = 'PayrollMonthlyPeriod/editPayrollMonthlyPeriod/$1';
$route['payroll-monthly-period/delete/(:num)']                    = 'PayrollMonthlyPeriod/deletePayrollMonthlyPeriod/$1';
$route['payroll-monthly-period/process-edit']                     = 'PayrollMonthlyPeriod/processEditPayrollMonthlyPeriod';
$route['payroll-monthly-period/reset-edit/(:num)']                 = 'PayrollMonthlyPeriod/reset_edit/$1';

/* PayrollEmployeeMonthly */
$route['payroll-employee-monthly']                                    = 'PayrollEmployeeMonthly';
$route['payroll-employee-monthly/add']                                 = 'PayrollEmployeeMonthly/addPayrollEmployeeMonthly';
$route['payroll-employee-monthly/elements-add']                         = 'PayrollEmployeeMonthly/function_elements_add';
$route['payroll-employee-monthly/reset-add']                         = 'PayrollEmployeeMonthly/reset_add';
$route['payroll-employee-monthly/process-add']                         = 'PayrollEmployeeMonthly/processAddPayrollEmployeeMonthly';
$route['payroll-employee-monthly/edit/(:num)']                        = 'PayrollEmployeeMonthly/editPayrollEmployeeMonthly/$1';
$route['payroll-employee-monthly/delete/(:num)']                        = 'PayrollEmployeeMonthly/deletePayrollEmployeeMonthly/$1';
$route['payroll-employee-monthly/process-edit']                      = 'PayrollEmployeeMonthly/processEditPayrollEmployeeMonthly';
$route['payroll-employee-monthly/reset-edit/(:num)']                 = 'PayrollEmployeeMonthly/reset_edit/$1';
$route['payroll-employee-monthly/detail/(:num)']                 = 'PayrollEmployeeMonthly/showdetail/$1';
