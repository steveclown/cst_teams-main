<?php
	class hroemployeetransfer_model extends CI_Model {
		var $table = "transaction_employee_transfer";
		
		public function hroemployeetransfer_model(){
			parent::__construct();
