<?php
	class payrollemployeemonthlyspa_model extends CI_Model {
		var $table = "hro_employee_allowance";
		
		public function payrollemployeemonthlyspa_model(){
			parent::__construct();
		...
		public function getPayrollEmployeePayment($employee_id, $employee_payment_period){
		...
		public function getAssignmentBusinessTrip($employee_id, $start_date, $end_date){
			$this->db->select('assignment_business_trip_spa.business_trip_id, assignment_business_trip_spa.employee_id, assignment_business_trip_spa.overtime_rate_id, assignment_overtime_rate.overtime_rate_description, assignment_business_trip_spa.business_trip_date, assignment_business_trip_spa.business_trip_destination, assignment_business_trip_spa.business_trip_amount');
			...
			$this->db->where('assignment_business_trip_spa.business_trip_date >=', $start_date);
			$this->db->where('assignment_business_trip_spa.business_trip_date <=', $end_date);
		...
		public function insertPayrollEmployeeMonthlyBusinessTrip($data){
			return $this->db->insert('payroll_employee_monthly_business_trip',$data);
		}
		...
		public function getCorePermit(){
			$this->db->select('core_permit.permit_id, core_permit.permit_name, core_permit.deduction_id, core_deduction.deduction_type, core_permit.permit_status');
			$this->db->from('core_permit');
