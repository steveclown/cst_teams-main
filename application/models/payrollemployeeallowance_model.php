<?php
	class payrollemployeeallowance_model extends CI_Model {
		var $table = "hro_employee_allowance";
		
		public function payrollemployeeallowance_model(){
			parent::__construct();
		...
		public function getHROEmployeeData_Allowance($region_id, $branch_id, $location_id, $payroll_employee_level, $employee_id, $division_id, $department_id, $section_id){
			$this->db->select('hro_employee_data.employee_id, hro_employee_data.employee_name, hro_employee_data.division_id, hro_employee_data.department_id, hro_employee_data.section_id');
			$this->db->from('hro_employee_data');
			$this->db->where('hro_employee_data.data_state',0);
			$this->db->where('hro_employee_data.region_id', $region_id);
		...
		public function saveNewPayrollEmployeeAllowance($data){
			return $this->db->insert('payroll_employee_allowance',$data);
		}

		public function getPayrollEmployeeAllowance_Data($employee_id){
			$this->db->select('payroll_employee_allowance.employee_allowance_id, payroll_employee_allowance.employee_id, payroll_employee_allowance.allowance_id, payroll_employee_allowance.employee_allowance_period, payroll_employee_allowance.employee_allowance_description, payroll_employee_allowance.employee_allowance_amount');
