<?php
	class CoreLengthServiceIlufa_model extends CI_Model {
		...
		public function getCoreLengthService_Detail($LengthServiceID){
			$this->db->select('core_length_service.length_service_id, core_length_service.length_service_code, core_length_service.length_service_name, core_length_service.length_service_range1, core_length_service.length_service_range2, core_length_service.length_service_amount, core_length_service.length_service_amount_multiply, core_length_service.length_service_min_saving, core_length_service.length_service_remark');
			$this->db->from('core_length_service');
