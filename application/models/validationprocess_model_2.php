<?php
	Class ValidationProcess_model extends CI_Model{
		...
		public function verifyData($data){
			$this->db->select('system_user.user_id, system_user.username, system_user.password, system_user.user_group_id, system_user.region_id, system_user.branch_id, system_user.location_id, system_user.employee_id, system_user.payroll_employee_level, system_user.employee_shift_id, system_user.branch_status');
