<?php
	class HroEmployeeAttendanceDiscrepancy_model extends CI_Model {
		...
		public function getHROEmployeeAttendanceData($region_id, $branch_id, $location_id, $start_date, $end_date, $employee_shift_id, $employee_id, $employee_attendance_date_status, $employee_attendance_late_status, $employee_attendance_overtime_status, $employee_attendance_homeearly_status){
			$this->db->select('hro_employee_attendance_data.employee_attendance_data_id, hro_employee_attendance_data.region_id, hro_employee_attendance_data.branch_id, hro_employee_attendance_data.location_id, hro_employee_attendance_data.employee_shift_id, schedule_employee_shift.employee_shift_code, hro_employee_attendance_data.employee_id, hro_employee_data.employee_name, hro_employee_attendance_data.employee_attendance_date, hro_employee_attendance_data.employee_attendance_in_date, hro_employee_attendance_data.employee_attendance_out_date, hro_employee_attendance_data.employee_attendance_working_time_hours, hro_employee_attendance_data.employee_attendance_working_time_minutes, hro_employee_attendance_data.employee_attendance_date_status, hro_employee_attendance_data.employee_attendance_working_status, hro_employee_attendance_data.employee_attendance_late_status, hro_employee_attendance_data.employee_attendance_overtime_status, hro_employee_attendance_data.employee_attendance_homeearly_status ');
