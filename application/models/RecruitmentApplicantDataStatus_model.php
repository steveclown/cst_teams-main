<?php
	class RecruitmentApplicantDataStatus_model extends CI_Model {
		...
		public function getRecruitmentApplicantDataStatus(){			
			...
			$this->db->from('recruitment_applicant_data');
			$this->db->where('recruitment_applicant_data.applicant_status', 1);
			$this->db->or_where('recruitment_applicant_data.applicant_status', 2);
			$this->db->or_where('recruitment_applicant_data.applicant_status', 3);
			$this->db->or_where('recruitment_applicant_data.applicant_status', 4);
			$this->db->where('recruitment_applicant_data.data_state', 0);
			$this->db->order_by('recruitment_applicant_data.applicant_id', 'DESC');
			$result = $this->db->get()->result_array();
			return $result;
