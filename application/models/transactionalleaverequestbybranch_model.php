<?php
	class transactionalleaverequestbybranch_model extends CI_Model {
		var $table = "transaction_leave_request";
		
		public function transactionalleaverequestbybranch(){
			parent::__construct();
		...
		public function saveNewtransactionalleaverequestbybranch($data){
		...
		public function saveEdittransactionalleaverequestbybranch($data){
