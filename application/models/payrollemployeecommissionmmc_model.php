<?php
	class payrollemployeecommissionmmc_model extends CI_Model {
		
		public function payrollemployeecommissionmmc_model(){
			parent::__construct();
		...
		public function getHROEmployeeData_CommissionMMC($region_id, $branch_id, $location_id, $employee_id, $division_id, $department_id, $section_id){
