<?php
	class hroemployeeemployment_model extends CI_Model {
		...
		public function getHROEmployeeEmployment($employee_id){
			$this->db->select('hro_employee_employment.employee_employment_id, hro_employee_employment.employee_id, hro_employee_employment.employee_employment_working_status, hro_employee_employment.employee_hire_date, hro_employee_employment.employee_employment_status, hro_employee_employment.employee_employment_status_date, hro_employee_employment.employee_employment_status_duedate, hro_employee_employment.employee_employment_overtime_status');
		...
		public function deleteHROEmployeeEmployment_Data($employee_employment_id){
			$this->db->where("employee_employment_id",$id);
		...
		public function deleteHROEmployeeEmployment($employee_id){
			$this->db->where("employee_id",$id);
			$query = $this->db->update('hro_employee_employment', array("data_state"=>1));
			if($query){
				return true;
