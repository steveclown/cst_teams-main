<?php
	Class hroemployeeworkingdayoffreport extends CI_Controller{
		...
		public function index(){
			...
			$data['main_view']['hroemployeeworkingdayoff_report']	= $this->hroemployeeworkingdayoffreport_model->getHROEmployeeWorkingDayOff_Report($region_id, $branch_id, $location_id, $sesi['division_id'], $sesi['department_id'] , $sesi['section_id'], $sesi['dayoff_id'], $start_date, $end_date);
