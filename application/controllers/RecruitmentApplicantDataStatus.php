<?php
	Class RecruitmentApplicantDataStatus extends MY_Controller{
		...
		public function index(){
			...
			$data['main_view']['recruitmentapplicantdata']		= $this->RecruitmentApplicantData_model->getRecruitmentApplicantDataStatus();
			...
			$data['main_view']['content']						= 'RecruitmentApplicantData/ListRecruitmentApplicantDataStatus_view';
		...
		public function processAddHROEmployeeData_Applicant(){
			...
			if($this->RecruitmentApplicantData_model->updateRecruitmentApplicantData($data)){
				$employeedata = array (
					...
					'employee_bank_acct_no'					=> $this->input->post('applicant_bank_acct_no',true),
					'employee_bank_acct_name'				=> $this->input->post('applicant_bank_acct_name',true),
