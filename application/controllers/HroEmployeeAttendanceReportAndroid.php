<?php
	...
	class HroEmployeeAttendanceReportAndroid extends CI_Controller{
		public function __construct(){
			parent::__construct();
			$this->load->model('MainPage_model');
			$this->load->model('HroEmployeeAttendanceReportAndroid_model');
		...
		public function index(){
			...
			$sesi	= $this->session->userdata('filter-HroEmployeeAttendanceReportAndroid');
			...
			$data_report = $this->HroEmployeeAttendanceReportAndroid_model->getHROEmployeeAttendanceReport($start_date, $employee_shift_id);
			
			$data['Main_view']['scheduleemployeescheduleitem']		= $data_report;
			$data['Main_view']['corelocation']						= create_double($this->HroEmployeeAttendanceReportAndroid_model->getCoreLocation(), 'location_id', 'location_name');			
			$data['Main_view']['content']							= 'HroEmployeeAttendanceReportAndroid/ListHroEmployeeAttendanceReportAndroid_view';
		...
		public function index_old(){
			...
			$scheduleemployeescheduleitem = $this->HroEmployeeAttendanceReportAndroid_model->getHROEmployeeAttendanceLog($query_count, $employee_shift_id);
		...
		public function function_elements_add(){
			...
			$sessions	= $this->session->userdata('addHroEmployeeAttendanceReportAndroid-'.$unique['unique']);
			$sessions[$name] = $value;
			$this->session->set_userdata('addHroEmployeeAttendanceReportAndroid-'.$unique['unique'],$sessions);
		}

		public function getScheduleEmployeeShift(){
			$location_id = $this->input->post('location_id');
			$item = $this->HroEmployeeAttendanceReportAndroid_model->getScheduleEmployeeShift($location_id);
		...
		public function filter(){
			...
			$this->session->set_userdata('filter-HroEmployeeAttendanceReportAndroid',$data);
			redirect('HroEmployeeAttendanceReportAndroid');
		}

		public function reset_search(){
			$sesi= $this->session->userdata('filter-HroEmployeeAttendanceReportAndroid');
			$this->session->unset_userdata('filter-HroEmployeeAttendanceReportAndroid');
			redirect('HroEmployeeAttendanceReportAndroid');
		}
		...
		public function processPrinting(){
			...
			$hroemployeeattendancelog = $this->HroEmployeeAttendanceReportAndroid_model->getHROEmployeeAttendanceLog_Print($query_count, $employee_shift_id);

			$employee_shift_code = $this->HroEmployeeAttendanceReportAndroid_model->getScheduleEmployeeShift_Detail($employee_shift_id);
		...
		public function exportHroEmployeeAttendanceReportAndroid(){
			$auth 	= $this->session->userdata('auth');
			$sesi	= $this->session->userdata('filter-HroEmployeeAttendanceReportAndroid');
