<?php
class PayrollPeriodData extends MY_Controller
{
	public function __construct()
	{
		parent::__construct();

		$menu = 'payroll-period-data';
	...
	public function reset_add_payment()
	{
		...
		redirect('payroll-period-data/add/' . $employee_id);
	}
	...
	public function processAddArrayPayrollPeriodPayment()
	{
		...
		if ($this->form_validation->run() == true) {
			...
			redirect('payroll-period-data/add');
		} else {
	...
	public function reset_edit()
	{
		...
		redirect('payroll-period-data/editPayrollPeriodData/' . $payroll_period_id);
	}
	...
	public function reset_edit_allowance()
	{
		...
		redirect('payroll-period-data/editPayrollPeriodData/' . $employee_id);
	}
