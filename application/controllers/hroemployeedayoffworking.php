<?php
	Class hroemployeeworkingdayoff extends CI_Controller{
		...
		public function index(){
			...
			$data['main_view']['hroemployeedata']			= create_double($this->hroemployeeworkingdayoff_model->getHROEmployeeData_Filter($region_id, $branch_id, $location_id),'employee_id','employee_name');

			$data['main_view']['hroemployeedata_workingdayoff']		= $this->hroemployeeworkingdayoff_model->getHROEmployeeData_WorkingDayOff($region_id, $branch_id, $location_id, $sesi['employee_id'], $sesi['division_id'], $sesi['department_id'] , $sesi['section_id']);
		...
		function addHROEmployeeWorkingDayOff(){
		...
		function processAddHROEmployeeWorkingDayOff(){
			$auth = $this->session->userdata('auth');
			$employee_id = $this->input->post('employee_id',true);
