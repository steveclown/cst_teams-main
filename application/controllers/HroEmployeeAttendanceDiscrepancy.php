<?php
	class HroEmployeeAttendanceDiscrepancy extends CI_Controller{
		public function __construct(){
			parent::__construct();
			$this->load->model('MainPage_model');
			$this->load->model('HroEmployeeAttendanceDiscrepancy_model');
		...
		public function index(){
			...
			$sesi	= 	$this->session->userdata('filter-HroEmployeeAttendanceDiscrepancy');
			if(!is_array($sesi)){
			...
			$data['Main_view']['corelocation']						= create_double($this->HroEmployeeAttendanceDiscrepancy_model->getCoreLocation(), 'location_id', 'location_name');

			$data['Main_view']['hroemployeeattendancedata']			= $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeAttendanceData($region_id, $branch_id, $sesi['location_id'], $start_date, $end_date, $sesi['employee_shift_id'], $sesi['employee_id'], $sesi['employee_attendance_date_status'], $sesi['employee_attendance_late_status'], $sesi['employee_attendance_overtime_status'], $sesi['employee_attendance_homeearly_status']);
			...
			$data['Main_view']['content']							= 'HroEmployeeAttendanceDiscrepancy/ListHroEmployeeAttendanceDiscrepancy_view';
			$this->load->view('MainPage_view',$data);
		}

		public function getScheduleEmployeeShift(){
			$location_id = $this->input->post('location_id');
			$item = $this->HroEmployeeAttendanceDiscrepancy_model->getScheduleEmployeeShift_Location($location_id);
		...
		public function getScheduleEmployeeShiftItem(){
			...
			$item = $this->HroEmployeeAttendanceDiscrepancy_model->getScheduleEmployeeShiftItem($employee_shift_id);
			$data .= "<option value=''>--Choose One--</option>";
			foreach ($item as $mp){
		...
		public function filter(){
			...
			$this->session->set_userdata('filter-HroEmployeeAttendanceDiscrepancy',$data);
			redirect('HroEmployeeAttendanceDiscrepancy');
		}

		public function reset_search(){
			$unique 	= $this->session->userdata('unique');
			$this->session->unset_userdata('addhroemployeedatadiscrepancy-'.$unique['unique']);
			$this->session->unset_userdata('filter-HroEmployeeAttendanceDiscrepancy');
			redirect('HroEmployeeAttendanceDiscrepancy');
		}
		...
		public function addHROEmployeeAttendanceDiscrepancy(){
			...
			$data['Main_view']['hroemployeedata']				= $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeData_Detail($employee_id);

			$data['Main_view']['hroemployeepermit']				= $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeePermit($employee_id);

			$data['Main_view']['corepermit']					= create_double($this->HroEmployeeAttendanceDiscrepancy_model->getCorePermit(),'permit_id','permit_name');

			$data['Main_view']['hroemployeeabsence']			= $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeAbsence($employee_id);

			$data['Main_view']['coreabsence']					= create_double($this->HroEmployeeAttendanceDiscrepancy_model->getCoreAbsence(),'absence_id','absence_name');

			$data['Main_view']['hroemployeeabsence']			= $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeAbsence($employee_id);

			$data['Main_view']['coreovertimetype']				= create_double($this->HroEmployeeAttendanceDiscrepancy_model->getCoreOvertimeType(),'overtime_type_id','overtime_type_name');

			$data['Main_view']['payrollovertimerequest']		= $this->HroEmployeeAttendanceDiscrepancy_model->getPayrollOvertimeRequest($employee_id);

			$data['Main_view']['corehomeearly']					= create_double($this->HroEmployeeAttendanceDiscrepancy_model->getCoreHomeEarly(), 'home_early_id','home_early_name');

			$data['Main_view']['hroemployeehomeearly']			= $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeHomeEarly($employee_id);

			$data['Main_view']['hroemployeecanceloff']			= $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeCancelOff($employee_id);

			$data['Main_view']['hroemployeeswapoff']			= $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeSwapOff($employee_id);

			$data['Main_view']['hroemployeeattendancestatus']	= $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeAttendanceStatus($employee_id);
			...
			$data['Main_view']['content']							= 'HroEmployeeAttendanceDiscrepancy/FormAddHroEmployeeAttendanceDiscrepancy_view';
		...
		public function function_state_add(){
			...
			$sessions	= $this->session->userdata('addHroEmployeeAttendanceDiscrepancy-'.$unique['unique']);
			$sessions['active_tab'] = $value;
			$this->session->set_userdata('addHroEmployeeAttendanceDiscrepancy-'.$unique['unique'],$sessions);
		}
		...
		public function reset_add_permit(){
			...
			redirect('HroEmployeeAttendanceDiscrepancy/addHROEmployeeAttendanceDiscrepancy/'.$employee_id.'/'.$employee_attendance_date.'/'.$employee_attendance_data_id);
		}
		...
		public function processAddHROEmployeePermit(){
			...
			$corepermit						= $this->HroEmployeeAttendanceDiscrepancy_model->getCorePermit_Detail($permit_id);

			$employee_attendance_date_status = $this->HroEmployeeAttendanceDiscrepancy_model->getEmployeeAttendanceDateStatus($employee_attendance_data_id);
			...
			if($this->form_validation->run()==true){
				if($this->HroEmployeeAttendanceDiscrepancy_model->insertHROEmployeePermit($data)){
					$employee_permit_id = $this->HroEmployeeAttendanceDiscrepancy_model->getEmployeePermitID($data['created_id']);
				    ...
				    if ($this->HroEmployeeAttendanceDiscrepancy_model->insertHROEmployeePermit_Detail($data_employeepermitdetail)){
				    	...
				    	if ($this->HroEmployeeAttendanceDiscrepancy_model->updateHROEmployeeAttendanceData_Status($dataupdate_attendancedata)){
				    		...
				    		$this->HroEmployeeAttendanceDiscrepancy_model->updateHROEmployeeAttendanceLog($dataupdate_attendancelog);
				    	}
				    }
					...
					$this->session->unset_userdata('addhroemployeepermit-'.$unique['unique']);	
					redirect('HroEmployeeAttendanceDiscrepancy/addHROEmployeeAttendanceDiscrepancy/'.$data['employee_id'].'/'.$employee_attendance_date.'/'.$employee_attendance_data_id);
				}else{
		...
		public function deleteHROEmployeePermit(){
			...
			if($this->HroEmployeeAttendanceDiscrepancy_model->deleteHROEmployeePermit($data_delete)){
				$auth = $this->session->userdata('auth');

				$hroemployeepermit_detail = $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeePermit_Detail($employee_permit_id);
		...
		public function processAddHROEmployeeAbsence(){
			...
			if($this->form_validation->run()==true){
				if($this->HroEmployeeAttendanceDiscrepancy_model->insertHROEmployeeAbsence($data)){
					$employee_absence_id = $this->HroEmployeeAttendanceDiscrepancy_model->getEmployeeAbsenceID($data['created_id']);
				    ...
				    if ($this->HroEmployeeAttendanceDiscrepancy_model->insertHROEmployeeAbsence_Detail($data_employeeabsencedetail)){
		...
		public function deleteHROEmployeeAbsence(){
			...
			if($this->HroEmployeeAttendanceDiscrepancy_model->deleteHROEmployeeAbsence($data_delete)){
				$auth = $this->session->userdata('auth');

				$hroemployeeabsence_detail = $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeAbsence_Detail($employee_absence_id);
		...
		public function processAddPayrollOvertimeRequest(){
			...
			if($this->form_validation->run()==true){
				if($this->HroEmployeeAttendanceDiscrepancy_model->insertPayrollOvertimeRequest($data)){
			    	...
			    	$this->HroEmployeeAttendanceDiscrepancy_model->updateHROEmployeeAttendanceData_Status($dataupdate_attendancedata);
		...
		public function deletePayrollOvertimeRequest(){
			...
			if($this->HroEmployeeAttendanceDiscrepancy_model->deletePayrollOvertimeRequest($data_delete)){
				$auth = $this->session->userdata('auth');
		...
		public function processAddHROEmployeeHomeEarly(){
			...
			if($this->form_validation->run()==true){
				if($this->HroEmployeeAttendanceDiscrepancy_model->insertHROEmployeeHomeEarly($data)){
		...
		public function deleteHROEmployeeHomeEarly(){
			...
			if($this->HroEmployeeAttendanceDiscrepancy_model->deleteHROEmployeeHomeEarly($data_delete)){
				$auth = $this->session->userdata('auth');

				$hroemployeehomeearly_detail = $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeHomeEarly_Detail($employee_home_early_id);
		...
		public function reset_add_canceloff(){
			...
			redirect('HroEmployeeAttendanceDiscrepancy/addHROEmployeeAttendanceDiscrepancy/'.$employee_id.'/'.$employee_absence_date.'/'.$employee_attendance_data_id);
		}
		...
		public function processAddHROEmployeeCancelOff(){
			...
			if($this->form_validation->run()==true){
				if($this->HroEmployeeAttendanceDiscrepancy_model->insertHROEmployeeCancelOff($data)){
					$dataupdate_attendancedata = array(
			    		'employee_attendance_data_id'		=> $employee_attendance_data_id,
			    		'employee_id'						=> $data['employee_id'],
		...
		public function deleteHROEmployeeCancelOff(){
			...
			$hroemployeecanceloff_detail = $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeCancelOff_Detail($employee_cancel_off_id);

			if($this->HroEmployeeAttendanceDiscrepancy_model->deleteHROEmployeeCancelOff($data_delete)){
				$auth = $this->session->userdata('auth');
		...
		public function processAddHROEmployeeSwapOff(){
			...
			$data_attendancedate_todate = $this->HroEmployeeAttendanceDiscrepancy_model->getEmployeeAttendanceDateStatus_ToDate($employee_id, $employee_swap_off_to_date);
			...
			if($this->form_validation->run()==true){
				if (!empty($data_attendancedate_todate)){
					...
					if($this->HroEmployeeAttendanceDiscrepancy_model->insertHROEmployeeSwapOff($data)){
						$dataupdate_attendancedata = array(
				    		'employee_attendance_data_id'		=> $employee_attendance_data_id,
				    		'employee_id'						=> $data['employee_id'],
		...
		public function deleteHROEmployeeSwapOff(){
			...
			$hroemployeeswapoff_detail = $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeSwapOff_Detail($employee_swap_off_id);
			...
			if($this->HroEmployeeAttendanceDiscrepancy_model->deleteHROEmployeeSwapOff($data_delete)){
				$auth = $this->session->userdata('auth');
		...
		public function processAddHROEmployeeAttendanceStatus(){
			...
			if($this->form_validation->run()==true){
				if($this->HroEmployeeAttendanceDiscrepancy_model->insertHROEmployeeAttendanceStatus($data)){
					$dataupdate_attendancedata = array(
			    		'employee_attendance_data_id'		=> $employee_attendance_data_id,
			    		'employee_id'						=> $data['employee_id'],
		...
		public function deleteHROEmployeeAttendanceStatus(){
			...
			$hroemployeeattendancestatus_detail = $this->HroEmployeeAttendanceDiscrepancy_model->getHROEmployeeAttendanceStatus_Detail($employee_attendance_status_id);

			if($this->HroEmployeeAttendanceDiscrepancy_model->deleteHROEmployeeAttendanceStatus($data_delete)){
				$auth = $this->session->userdata('auth');
