    ...
    fnInit: function (oSettings, nPaging, fnDraw) {
      ...
      $(nPaging).append(
        '<div class="pagination-panel"> ' +
          ...
          '<input type="text" autocomplete="off"  class="pagination-panel-input form-control input-sm input-inline input-mini" maxlenght="5" style="text-align:center; margin: 0 5px;">' +
