...
rangy.createModule("DomRange", function (api, module) {
  ...
  function assertValidOffset(node, offset) {
    if (
      offset < 0 ||
      offset >
        (dom.isCharacterDataNode(node) ? node.length : node.childNodes.length)
    ) {
  ...
  RangePrototype.prototype = {
    ...
    comparePoint: function (node, offset) {
      ...
      if (
        dom.comparePoints(node, offset, this.startContainer, this.startOffset) <
        0
      ) {
        return -1;
      } else if (
...
rangy.createModule("WrappedRange", function (api, module) {
  ...
  function getTextRangeBoundaryPosition(
    ...
    if (
      ...
      if (/[\r\n]/.test(boundaryNode.data)) {
        ...
        while (
          (comparison = tempRange.compareEndPoints("StartToEnd", tempRange)) ==
          -1
        ) {
          offset++;
  ...
  function createBoundaryTextRange(boundaryPosition, isStart) {
    ...
    if (nodeIsDataNode) {
      ...
      boundaryNode =
        boundaryOffset < childNodes.length ? childNodes[boundaryOffset] : null;
...
rangy.createModule("WrappedSelection", function (api, module) {
  ...
  selProto.toHtml = function () {
    var html = "";
    if (this.rangeCount) {
      var container = DomRange.getRangeDocument(this._ranges[0]).createElement(
        "div"
      );
      for (var i = 0, len = this._ranges.length; i < len; ++i) {
...
wysihtml5.browser = (function () {
  ...
  return {
    ...
    isIos: function () {
      var userAgent = this.USER_AGENT.toLowerCase();
      return (
        userAgent.indexOf("webkit") !== -1 && userAgent.indexOf("mobile") !== -1
      );
    },
    ...
    /** @scope wysihtml5.Selection.prototype */ {
      ...
      executeAndRestoreSimple: function (method) {
        ...
        rangeBackup = {
          ...
          startOffset:
            firstNode === range.startContainer ? range.startOffset : 0,
          endContainer: lastNode,
          endOffset:
            lastNode === range.endContainer ? range.endOffset : lastNode.length,
        };
...
(function (wysihtml5) {
  ...
  wysihtml5.commands.formatInline = {
    ...
    state: function (composer, command, tagName, className, classRegExp) {
      ...
      return _getApplier(tagName, className, classRegExp).isAppliedToRange(
        range
      );
    },
...
(function (wysihtml5) {
  ...
  wysihtml5.toolbar.Dialog = wysihtml5.lang.Dispatcher.extend(
    /** @scope wysihtml5.toolbar.Dialog.prototype */ {
       ...
       *    <input type="text" autocomplete="off"  data-wysihtml5-dialog-field="href" value="">
       *    <input type="text" autocomplete="off"  data-wysihtml5-dialog-field="target" value="">
       *
       * after calling _interpolate() the dialog will look like this
       *    <input type="text" autocomplete="off"  data-wysihtml5-dialog-field="href" value="http://www.google.com">
       *    <input type="text" autocomplete="off"  data-wysihtml5-dialog-field="target" value="_blank">
       *
